...
CREATE TABLE `oil` (
  ...
  `customer_comission_unit_id` int(11) DEFAULT NULL,
  `customer_comission_percent` float DEFAULT NULL,
  `customer_comission_amount` double DEFAULT NULL,
  `vendor_comission_unit_id` int(11) DEFAULT NULL,
  `vendor_comission_percent` float DEFAULT NULL,
  `vendor_comission_amount` double DEFAULT NULL,
  `note` text COLLATE utf8_unicode_ci,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
