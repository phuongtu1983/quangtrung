...
insert  into `lpg_import`(`id`,`code`,`import_date`,`vendor_id`,`paper_quantity`,`actual_quantity`,`price`,`amount`,`paid`,`debt`,`rate`,`note`,`account_id`) values (13,'20180930-LI-0001','2018-09-30',9,1,2,3,3,4,-1,5,'',5);
...
insert  into `vendor`(`id`,`code`,`name`,`organization_id`,`status`,`equal_organization_id`) values (8,'a','a',1,1,-1),(9,'qt','qt',1,1,1),(10,'HT','HT',14,1,-1);
