...
insert  into `lpg_import`(`id`,`code`,`import_date`,`vendor_id`,`paper_quantity`,`actual_quantity`,`price`,`amount`,`paid`,`debt`,`rate`,`note`,`account_id`) values (10,'20180920-LI-0001','2018-09-20',5,1000,1010,20000,20000000,20000000,0,22753,'test',5),(11,'20180928-LI-0001','2018-09-28',5,2000,1000,15000,30000000,20000000,10000000,22753,'a',5),(12,'20180929-LI-0001','2018-09-29',4,3000,2500,50000,150000000,50000000,100000000,22345,'hello',5);
...
insert  into `permission`(`id`,`name`,`note`,`users`,`organizations`) values (8,'admin','Quyền quản trị hệ thống','1','1,14'),(9,'Admin Quang Trung','','11','1');
...
CREATE TABLE `vendor` (
  ...
  `equal_organization_id` int(11) DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

/*Data for the table `vendor` */

insert  into `vendor`(`id`,`code`,`name`,`organization_id`,`status`,`equal_organization_id`) values (5,'PEN','Petronas',1,1,0),(4,'PEV','Petrolimex',1,1,0);
