...
insert  into `accessory_in_stock`(`id`,`day`,`accessory_id`,`in_stock`) values (73,'2018-10-03',3,0),(74,'2018-10-03',4,0),(75,'2018-10-03',5,0);
...
insert  into `auto`(`id`,`auto_date`,`auto_name`) values (14,'2018-10-03','in_stock'),(15,'2018-10-02','in_stock');
...
insert  into `gas_wholesale`(`id`,`code`,`created_date`,`customer_id`,`total`,`discount`,`total_pay`,`paid`,`debt`,`account_id`,`vehicle_id`,`note`,`gas_return`,`gas_return_price`,`gas_return_amount`) values (4,'20181003-GS-0002','2018-10-03',2,2800000,0,2783000,2783000,0,4,0,'abc',10,1667,17000),(3,'20181003-GS-0001','2018-10-03',2,290000,0,290000,290000,0,5,0,'',0,1667,0),(5,'20181003-GS-0003','2018-10-03',6,400000,0,400000,400000,0,5,5,'',0,1667,0),(6,'20181003-GS-0004','2018-10-03',6,900000,0,900000,900000,0,5,5,'',0,2500,0);
...
insert  into `gas_wholesale_detail`(`id`,`gas_wholesale_id`,`shell_id`,`quantity`,`price`,`amount`) values (6,3,2,4,40000,160000),(5,3,1,3,30000,90000),(4,3,3,2,20000,40000),(7,4,3,10,20000,200000),(8,4,1,20,30000,600000),(9,4,2,40,50000,2000000),(10,5,1,20,20000,400000),(11,6,2,30,30000,900000);
...
BEGIN
	SELECT c.code as customer_code, c.NAME AS customer_name, SUM(tbl.quantity_12) AS quantity_12, SUM(tbl.quantity_45) AS quantity_45
		...
		, SUM(tbl.total) AS amount, sum(tbl.paid) AS paid
	FROM customer as c 
	left join
	(
