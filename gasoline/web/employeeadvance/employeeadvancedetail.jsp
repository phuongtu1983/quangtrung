            ...
            <tr><td>
                    <table cellspacing="0" cellpadding="0" style="border-width: 0px">
                        <tr>
                            ...
                            <td><html:text property="code" size="30" name="<%=Constants.EMPLOYEE_ADVANCE%>" readonly="true" tabindex="-1"/></td>
                            <td style="padding-right: 20px;padding-left: 10px"><bean:message key="date.title"/></td>
                            <td><html:text property="advanceDate" styleId="employeeAdvanceDate" size="30" name="<%=Constants.EMPLOYEE_ADVANCE%>" tabindex="-1"/></td>
                        </tr>
                        <tr>
                ...
                <td align="center">
                    <p style="margin-top: 0; margin-bottom: 0">
                        ...
                        <logic:notEqual name="<%=Constants.EMPLOYEE_ADVANCE%>" property="id" value="0">
                            <logic:equal name="<%=Constants.EMPLOYEE_ADVANCE%>" property="canEdit" value="1">
