    ...
    <tbody>
        <logic:iterate id="good" name="<%=Constants.SALE_SHELL_GOOD%>">
            <tr>
                ...
                <td><input type="text" size="20" name="quantity" value="${good.quantity}" id="detquantity${good.shellId}" onblur="return caculateFormListDetail('${good.shellId}','saleShellForm');" onkeypress="return readonlyFloat(event);"/></td>
                <td><input type="text" size="20" name="price" value="${good.price}" id="detprice${good.shellId}" onblur="return caculateFormListDetail('${good.shellId}','saleShellForm');" onkeypress="return readonlyFloat(event);" tabindex="-1"/></td>
