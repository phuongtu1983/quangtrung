        ...
        <tr>
            ...
            <td>
                <logic:equal name="<%=Constants.SALE_SHELL%>" property="id" value="0">
                    <html:text property="createdDate" size="30" name="<%=Constants.SALE_SHELL%>" styleId="saleShellCreatedDate"/>
                </logic:equal>
                <logic:notEqual name="<%=Constants.SALE_SHELL%>" property="id" value="0">
                    <html:text property="createdDate" size="30" name="<%=Constants.SALE_SHELL%>" styleId="saleShellCreatedDate" readonly="true"/>
                </logic:notEqual>
            </td>
        </tr>
        <tr>
