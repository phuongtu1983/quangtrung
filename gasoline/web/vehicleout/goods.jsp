...
<table class="its" id="vehicleOutGoodTbl">
    <logic:iterate id="good" name="<%=Constants.VEHICLE_OUT_GOOD%>">
        <tr>
            ...
            <td><input type="text" size="20" name="price" id="detprice${good.id}" value="${good.price}" onblur="return caculateFormListDetail('${good.id}',null);" onkeypress="return readonlyFloat(event);"/></td>
