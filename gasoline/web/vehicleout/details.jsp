    ...
    <tbody>
        <logic:iterate id="good" name="<%=Constants.VEHICLE_OUT_GOOD%>">
            <tr>
                ...
                <td><input type="text" size="20" name="price" value="${good.price}" id="detprice${good.shellId}" onblur="return caculateFormListDetail('${good.shellId}',null);" onkeypress="return readonlyFloat(event);"/></td>
