...
<table class="its" id="goodImportGoodTbl">
    <logic:iterate id="good" name="<%=Constants.GOOD_IMPORT_GOOD%>">
        <tr>
            ...
            <td><input type="text" size="20" name="quantity" id="detquantity${good.goodId}" value="0" onblur="return caculateFormListDetail('${good.goodId}','goodImportForm');" onkeyup="try2FloatFormatOnKeyUp(this, event);" onkeypress="return readonlyFloat(event);"/></td>
            <td><input type="text" size="20" name="price" id="detprice${good.goodId}" value="0" onblur="return caculateFormListDetail('${good.goodId}','goodImportForm');" onkeyup="try2FloatFormatOnKeyUp(this,event);" onkeypress="return readonlyFloat(event);"/></td>
