...
<table class="its" id="gasWholesaleShellTbl">
    <logic:iterate id="shell" name="<%=Constants.GAS_WHOLESALE_SHELL%>">
        <tr>
            ...
            <td><input type="text" size="20" name="price" id="detprice${shell.shellId}" value="0" onblur="return caculateFormListDetail('${shell.shellId}','gasWholesaleForm');" onkeypress="return readonlyFloat(event);" tabindex="-1"/></td>
