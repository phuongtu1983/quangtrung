        ...
        <table>
            ...
            <tr>
                <td colspan="3" align="center">
                    <button class="i_printer icon small" onclick="return printOilStockStoreHReport(document.forms['reportOilStockStoreHSearchForm'].fromDate.value, document.forms['reportOilStockStoreHSearchForm'].toDate.value);">In</button>
