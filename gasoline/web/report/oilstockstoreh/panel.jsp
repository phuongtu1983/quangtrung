...
<form name='reportOilStockStoreHSearchForm' id='reportOilStockStoreHSearchForm'>
    <fieldset>
        ...
        <table>
            <tr>
                ...
                <td colspan="2">
                    <select id="reportOilStockStoreHSearchFormTime" style="width:200px" onchange="return reportTimeChange(this, 'reportOilStockStoreHSearchForm')">
            ...
            <tr>
                <td colspan="3" align="center">
                    <button class="i_printer icon small" onclick="return printOilStockStoreHReport(document.forms['reportOilStockStoreHSearchForm'].fromDate.value, document.forms['reportOilStockStoreHSearchForm'].toDate.value);"><bean:message key="message.permission.permit.download"/></button>
