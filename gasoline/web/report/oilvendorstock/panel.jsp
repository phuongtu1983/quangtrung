        ...
        <table>
            ...
            <tr>
                <td colspan="3" align="center">
                    <button class="i_printer icon small" onclick="return printOilVendorStockReport(document.forms['reportOilVendorStockSearchForm'].fromDate.value, document.forms['reportOilVendorStockSearchForm'].toDate.value);">In</button>
