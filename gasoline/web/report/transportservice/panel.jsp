        ...
        <table>
            ...
            <tr>
                <td colspan="3" align="center">
                    <button class="i_printer icon small" onclick="return printTransportServiceReport(document.forms['reportTransportServiceSearchForm'].fromDate.value, document.forms['reportTransportServiceSearchForm'].toDate.value);"><bean:message key="message.permission.permit.download"/></button>
