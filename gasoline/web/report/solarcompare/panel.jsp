...
<form name='reportSolarCompareSearchForm' id='reportSolarCompareSearchForm'>
    <fieldset>
        ...
        <table>
            <tr>
                ...
                <td colspan="2">
                    <select id="reportSolarCompareSearchFormTime" style="width:200px" onchange="return reportTimeChange(this, 'reportSolarCompareSearchForm')">
            ...
            <tr>
                <td colspan="3" align="center">
                    <button class="i_printer icon small" onclick="return printSolarComapreReport(document.forms['reportSolarCompareSearchForm'].fromDate.value, document.forms['reportSolarCompareSearchForm'].toDate.value);"><bean:message key="message.permission.permit.download"/></button>
