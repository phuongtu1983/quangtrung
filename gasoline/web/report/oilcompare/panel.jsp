        ...
        <table>
            ...
            <tr>
                <td colspan="3" align="center">
                    <button class="i_printer icon small" onclick="return printOilComapreReport(document.forms['reportOilCompareSearchForm'].fromDate.value, document.forms['reportOilCompareSearchForm'].toDate.value);">In</button>
