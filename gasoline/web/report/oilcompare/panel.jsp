...
<form name='reportOilCompareSearchForm' id='reportOilCompareSearchForm'>
    <fieldset>
        ...
        <table>
            <tr>
                ...
                <td colspan="2">
                    <select id="reportOilCompareSearchFormTime" style="width:200px" onchange="return reportTimeChange(this, 'reportOilCompareSearchForm')">
            ...
            <tr>
                <td colspan="3" align="center">
                    <button class="i_printer icon small" onclick="return printOilComapreReport(document.forms['reportOilCompareSearchForm'].fromDate.value, document.forms['reportOilCompareSearchForm'].toDate.value);"><bean:message key="message.permission.permit.download"/></button>
