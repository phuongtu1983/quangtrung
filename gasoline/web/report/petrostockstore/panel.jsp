        ...
        <table>
            ...
            <tr>
                <td colspan="3" align="center">
                    <button class="i_printer icon small" onclick="return printPetroStockStoreReport(document.forms['reportPetroStockStoreSearchForm'].fromDate.value, document.forms['reportPetroStockStoreSearchForm'].toDate.value);">In</button>
