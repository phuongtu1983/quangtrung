...
<form name='reportSolarVendorStockSearchForm' id='reportSolarVendorStockSearchForm'>
    <fieldset>
        ...
        <table>
            <tr>
                ...
                <td colspan="2">
                    <select id="reportSolarVendorStockSearchFormTime" style="width:200px" onchange="return reportTimeChange(this, 'reportSolarVendorStockSearchForm')">
            ...
            <tr>
                <td colspan="3" align="center">
                    <button class="i_printer icon small" onclick="return printSolarVendorStockReport(document.forms['reportSolarVendorStockSearchForm'].fromDate.value, document.forms['reportSolarVendorStockSearchForm'].toDate.value);"><bean:message key="message.permission.permit.download"/></button>
