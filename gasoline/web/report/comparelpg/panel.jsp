        ...
        <table>
            ...
            <tr>
                <td colspan="3" align="center">
                    <button class="i_printer icon small" onclick="return printComapreLPGReport(document.forms['reportCompareLPGSearchForm'].fromDate.value, document.forms['reportCompareLPGSearchForm'].toDate.value);">In</button>
