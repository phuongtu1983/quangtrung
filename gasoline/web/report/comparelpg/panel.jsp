...
<form name='reportCompareLPGSearchForm' id='reportCompareLPGSearchForm'>
    <fieldset>
        ...
        <table>
            <tr>
                ...
                <td colspan="2">
                    <select id="reportCompareLPGSearchFormTime" style="width:200px" onchange="return reportTimeChange(this, 'reportCompareLPGSearchForm')">
            ...
            <tr>
                <td colspan="3" align="center">
                    <button class="i_printer icon small" onclick="return printComapreLPGReport(document.forms['reportCompareLPGSearchForm'].fromDate.value, document.forms['reportCompareLPGSearchForm'].toDate.value);"><bean:message key="message.permission.permit.download"/></button>
