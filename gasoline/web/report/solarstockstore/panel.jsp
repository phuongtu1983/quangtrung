...
<form name='reportSolarStockStoreSearchForm' id='reportSolarStockStoreSearchForm'>
    <fieldset>
        ...
        <table>
            <tr>
                ...
                <td colspan="2">
                    <select id="reportSolarStockStoreSearchFormTime" style="width:200px" onchange="return reportTimeChange(this, 'reportSolarStockStoreSearchForm')">
            ...
            <tr>
                <td colspan="3" align="center">
                    <button class="i_printer icon small" onclick="return printSolarStockStoreReport(document.forms['reportSolarStockStoreSearchForm'].fromDate.value, document.forms['reportSolarStockStoreSearchForm'].toDate.value);"><bean:message key="message.permission.permit.download"/></button>
