        ...
        <table>
            ...
            <tr>
                <td colspan="3" align="center">
                    <button class="i_printer icon small" onclick="return printSolarStockStoreReport(document.forms['reportSolarStockStoreSearchForm'].fromDate.value, document.forms['reportSolarStockStoreSearchForm'].toDate.value);">In</button>
