...
<form name='reportCompareCustomerCommissionSearchForm' id='reportCompareCustomerCommissionSearchForm'>
    <fieldset>
        ...
        <table>
            <tr>
                ...
                <td colspan="2">
                    <select id="reportCompareCustomerCommissionSearchFormTime" style="width:200px" onchange="return reportTimeChange(this, 'reportCompareCustomerCommissionSearchForm')">
            ...
            <tr>
                <td colspan="3" align="center">
                    <button class="i_printer icon small" onclick="return printCompareCustomerCommissionReport(document.forms['reportCompareCustomerCommissionSearchForm'].fromDate.value, document.forms['reportCompareCustomerCommissionSearchForm'].toDate.value);"><bean:message key="message.permission.permit.download"/></button>
