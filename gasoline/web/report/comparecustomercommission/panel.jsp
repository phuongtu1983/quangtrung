        ...
        <table>
            ...
            <tr>
                <td colspan="3" align="center">
                    <button class="i_printer icon small" onclick="return printCompareCustomerCommissionReport(document.forms['reportCompareCustomerCommissionSearchForm'].fromDate.value, document.forms['reportCompareCustomerCommissionSearchForm'].toDate.value);">In</button>
