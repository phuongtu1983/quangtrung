        ...
        <table>
            ...
            <tr>
                <td colspan="3" align="center">
                    <button class="i_printer icon small" onclick="return printOilStockStoreReport(document.forms['reportOilStockStoreSearchForm'].fromDate.value, document.forms['reportOilStockStoreSearchForm'].toDate.value);">In</button>
