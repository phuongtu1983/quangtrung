...
<form name='reportOilStockStoreSearchForm' id='reportOilStockStoreSearchForm'>
    <fieldset>
        ...
        <table>
            <tr>
                ...
                <td colspan="2">
                    <select id="reportOilStockStoreSearchFormTime" style="width:200px" onchange="return reportTimeChange(this, 'reportOilStockStoreSearchForm')">
            ...
            <tr>
                <td colspan="3" align="center">
                    <button class="i_printer icon small" onclick="return printOilStockStoreReport(document.forms['reportOilStockStoreSearchForm'].fromDate.value, document.forms['reportOilStockStoreSearchForm'].toDate.value);"><bean:message key="message.permission.permit.download"/></button>
