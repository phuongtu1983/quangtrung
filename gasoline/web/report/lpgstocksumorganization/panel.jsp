...
<form name='reportLpgStockSumOrganizationSearchForm' id='reportLpgStockSumOrganizationSearchForm'>
    <fieldset>
        ...
        <table>
            <tr>
                ...
                <td colspan="2">
                    <select id="reportLpgStockSumOrganizationSearchFormTime" style="width:200px" onchange="return reportTimeChange(this, 'reportLpgStockSumOrganizationSearchForm')">
            ...
            <tr>
                <td colspan="3" align="center">
                    <button class="i_printer icon small" onclick="return printLpgStockSumOrganizationReport(document.forms['reportLpgStockSumOrganizationSearchForm'].fromDate.value, document.forms['reportLpgStockSumOrganizationSearchForm'].toDate.value);"><bean:message key="message.permission.permit.download"/></button>
