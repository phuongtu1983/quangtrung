        ...
        <table>
            ...
            <tr>
                <td colspan="3" align="center">
                    <button class="i_printer icon small" onclick="return printComapreGoodReport(document.forms['reportCompareGoodSearchForm'].fromDate.value, document.forms['reportCompareGoodSearchForm'].toDate.value);">In</button>
