        ...
        <table>
            ...
            <tr>
                <td colspan="3" align="center">
                    <button class="i_printer icon small" onclick="return printComapreLPGVendorCustomerReport(document.forms['reportCompareLPGVendorCustomerSearchForm'].fromDate.value, document.forms['reportCompareLPGVendorCustomerSearchForm'].toDate.value);">In</button>
