        ...
        <table>
            ...
            <tr>
                <td colspan="3" align="center">
                    <button class="i_printer icon small" onclick="return printEmployeeVehicleSalaryReport(document.forms['reportEmployeeVehicleSalarySearchForm'].fromDate.value, document.forms['reportEmployeeVehicleSalarySearchForm'].toDate.value);"><bean:message key="message.permission.permit.download"/></button>
