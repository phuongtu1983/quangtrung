        ...
        <table>
            ...
            <tr>
                <td colspan="3" align="center">
                    <button class="i_printer icon small" onclick="return printComapreReport(document.forms['reportCompareSearchForm'].fromDate.value, document.forms['reportCompareSearchForm'].toDate.value);"><bean:message key="message.permission.permit.download"/></button>
