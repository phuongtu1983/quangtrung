...
<form name='reportCompareGasSearchForm' id='reportCompareGasSearchForm'>
    <fieldset>
        ...
        <table>
            <tr>
                ...
                <td colspan="2">
                    <select id="reportCompareGasSearchFormTime" style="width:200px" onchange="return reportTimeChange(this, 'reportCompareGasSearchForm')">
            ...
            <tr>
                <td colspan="3" align="center">
                    <button class="i_printer icon small" onclick="return printComapreGasReport(document.forms['reportCompareGasSearchForm'].fromDate.value, document.forms['reportCompareGasSearchForm'].toDate.value);"><bean:message key="message.permission.permit.download"/></button>
