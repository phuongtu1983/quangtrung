        ...
        <table>
            ...
            <tr>
                <td colspan="3" align="center">
                    <button class="i_printer icon small" onclick="return printComapreGasReport(document.forms['reportCompareGasSearchForm'].fromDate.value, document.forms['reportCompareGasSearchForm'].toDate.value);">In</button>
