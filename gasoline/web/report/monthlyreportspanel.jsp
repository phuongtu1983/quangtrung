        ...
        <table>
            ...
            <tr>
                <td colspan="3" align="center">
                    <button class="i_printer icon small" onclick="return printMonthlyReport(document.forms['monthlyReportSearchForm'].fromDate.value, document.forms['monthlyReportSearchForm'].toDate.value);"><bean:message key="message.permission.permit.download"/></button>
