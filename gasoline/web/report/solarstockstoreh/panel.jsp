        ...
        <table>
            ...
            <tr>
                <td colspan="3" align="center">
                    <button class="i_printer icon small" onclick="return printSolarStockStoreHReport(document.forms['reportSolarStockStoreHSearchForm'].fromDate.value, document.forms['reportSolarStockStoreHSearchForm'].toDate.value);">In</button>
