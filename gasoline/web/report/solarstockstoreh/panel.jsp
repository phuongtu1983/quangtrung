...
<form name='reportSolarStockStoreHSearchForm' id='reportSolarStockStoreHSearchForm'>
    <fieldset>
        ...
        <table>
            <tr>
                ...
                <td colspan="2">
                    <select id="reportSolarStockStoreHSearchFormTime" style="width:200px" onchange="return reportTimeChange(this, 'reportSolarStockStoreHSearchForm')">
            ...
            <tr>
                <td colspan="3" align="center">
                    <button class="i_printer icon small" onclick="return printSolarStockStoreHReport(document.forms['reportSolarStockStoreHSearchForm'].fromDate.value, document.forms['reportSolarStockStoreHSearchForm'].toDate.value);"><bean:message key="message.permission.permit.download"/></button>
