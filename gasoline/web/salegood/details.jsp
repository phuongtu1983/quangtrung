    ...
    <tbody>
        <logic:iterate id="good" name="<%=Constants.SALE_GOOD_GOOD%>">
            <tr>
                ...
                <td><input type="text" size="20" name="price" value="${good.price}" id="detprice${good.goodId}" onblur="return caculateFormListDetail('${good.goodId}','saleGoodForm');" onkeypress="return readonlyFloat(event);" tabindex="-1"/></td>
