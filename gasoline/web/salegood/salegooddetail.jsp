...
<form name="saleGoodForm">
    <table style="width: 100%">
        <tr>
            ...
            <td><html:text property="createdDate" size="30" name="<%=Constants.SALE_GOOD%>" styleId="saleGoodCreatedDate" readonly="true"/></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <html:select property="customerId" name="<%=Constants.SALE_GOOD%>" style="width:195px">
        ...
        <tr>
            ...
            <td><html:text property="discount" size="30" name="<%=Constants.SALE_GOOD%>" onblur="return formPaidDiscountChanged('saleGoodForm');" onkeyup="try2FloatFormatOnKeyUp(this,event);" onkeypress="return readonlyFloat(event);"/></td>
        ...
        <tr>
            ...
            <td><html:text property="paid" size="30" name="<%=Constants.SALE_GOOD%>" onblur="return formPaidDiscountChanged('saleGoodForm');" onkeyup="try2FloatFormatOnKeyUp(this,event);" onkeypress="return readonlyFloat(event);"/></td>
        ...
        <tr>
            <td colspan="4" align="center" height="50">
                ...
                <logic:greaterThan name="<%=Constants.SALE_GOOD%>" property="id" value="0">
