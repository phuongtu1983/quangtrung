...
<table width="100%" cellspacing="0" cellpadding="0" >
    <tr>
        <td height="30" style="padding-right: 20px"><bean:message key="date.title"/></td>
        <td colspan="2"><input type="text" size="30" value="" id="openingStockDate"></td>
    </tr>
    <tr>
        <td height="30" style="padding-right: 20px"><bean:message key="accessory.title"/></td>
        <td><button class="i_printer icon small" onclick="return printOpeningStockExport('accessory');">Export</button></td>
