...
<table class="its">
    ...
    <%if (PermissionUtil.hasPermission(request, PermissionUtil.OPERATION_LIST, PermissionUtil.PER_OPENING_STOCK_ACCESSORY)) {%> 
    <tr class="even">
    ...
    <%}%>
    <%if (PermissionUtil.hasPermission(request, PermissionUtil.OPERATION_LIST, PermissionUtil.PER_OPENING_STOCK_CUSTOMER)) {%> 
    <tr class="odd">
    ...
    <%}%>
    <%if (PermissionUtil.hasPermission(request, PermissionUtil.OPERATION_LIST, PermissionUtil.PER_OPENING_STOCK_GOOD)) {%> 
    <tr class="even">
    ...
    <%}%>
    <%if (PermissionUtil.hasPermission(request, PermissionUtil.OPERATION_LIST, PermissionUtil.PER_OPENING_STOCK_LPG)) {%> 
    <tr class="odd">
    ...
    <%}%>
    <%if (PermissionUtil.hasPermission(request, PermissionUtil.OPERATION_LIST, PermissionUtil.PER_OPENING_STOCK_CASH)) {%> 
    <tr class="even">
    ...
    <%}%>
    <%if (PermissionUtil.hasPermission(request, PermissionUtil.OPERATION_LIST, PermissionUtil.PER_OPENING_STOCK_PETRO)) {%> 
    <tr class="odd">
    ...
    <%}%>
    <%if (PermissionUtil.hasPermission(request, PermissionUtil.OPERATION_LIST, PermissionUtil.PER_OPENING_STOCK_PROMOTION_MATERIAL)) {%> 
    <tr class="even">
    ...
    <%}%>
    <%if (PermissionUtil.hasPermission(request, PermissionUtil.OPERATION_LIST, PermissionUtil.PER_OPENING_STOCK_GAS_SHELL)) {%> 
    <tr class="odd">
    ...
    <%}%>
    <%if (PermissionUtil.hasPermission(request, PermissionUtil.OPERATION_LIST, PermissionUtil.PER_OPENING_STOCK_SHELL)) {%> 
    <tr class="even">
    ...
    <%}%>
    <%if (PermissionUtil.hasPermission(request, PermissionUtil.OPERATION_LIST, PermissionUtil.PER_OPENING_STOCK_SHIELD)) {%> 
    <tr class="odd">
    ...
    <%}%>
    <%if (PermissionUtil.hasPermission(request, PermissionUtil.OPERATION_LIST, PermissionUtil.PER_OPENING_STOCK_VENDOR)) {%> 
    <tr class="even">
    ...
    <%}%>
    <%if (PermissionUtil.hasPermission(request, PermissionUtil.OPERATION_LIST, PermissionUtil.PER_OPENING_STOCK_OIL)) {%> 
    <tr class="even">
    ...
    <%}%>
    <%if (PermissionUtil.hasPermission(request, PermissionUtil.OPERATION_LIST, PermissionUtil.PER_OPENING_STOCK_SOLAR)) {%> 
    <tr class="even">
        <td height="30" style="padding-right: 20px"><bean:message key="solar.title"/></td>
        <td><button class="i_printer icon small" onclick="return printOpeningStockExport('solar');">Export</button></td>
        <td><button class="i_buildings icon small green" onclick="return importOpeningStock('solar');">Import</button></td>
    </tr>
    <%}%>
</table>