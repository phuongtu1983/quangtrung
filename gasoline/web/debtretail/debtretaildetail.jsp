            ...
            <tr><td>
                    <table cellspacing="0" cellpadding="0" style="border-width: 0px">
                        <tr>
                            ...
                            <td><html:text property="createdDate" styleId="debtRetailDate" size="30" name="<%=Constants.DEBT_RETAIL%>" readonly="true"/></td>
                        </tr>
                        <tr>
                            ...
                            <td><html:text property="paid" size="30" name="<%=Constants.DEBT_RETAIL%>" onblur="tryNumberFormatCurrentcy(this);" onkeypress="return readonlyFloat(event);"/></td>
                        </tr>
                        <tr>
