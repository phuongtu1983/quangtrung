            ...
            <tr><td>
                    <table cellspacing="0" cellpadding="0" style="border-width: 0px">
                        <tr>
                            ...
                            <td><html:text property="code" size="30" name="<%=Constants.OLD_SHELL%>" readonly="true"/></td>
                        ...
                        <tr>
                            <td height="30" style="padding-right: 20px"><bean:message key="shell.detail.name"/></td>
                            <td><html:text property="name" size="30" name="<%=Constants.OLD_SHELL%>" readonly="true"/></td>
                        ...
                        <tr>
                            ...
                            <td colspan="3"><html:text property="note" size="80" name="<%=Constants.OLD_SHELL%>"/></td>
                        </tr>
                    </table>
                </td></tr>
            <tr>
