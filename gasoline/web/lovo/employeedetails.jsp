<%@ page import="com.stepup.gasoline.qt.bean.LoVoEmployeeDetailBean"%>
<%@ page import="com.stepup.gasoline.qt.util.Constants"%>
<%@ taglib uri="/WEB-INF/struts-logic.tld" prefix="logic" %>
<%@ taglib uri="/WEB-INF/struts-bean.tld" prefix="bean" %>
<table id="loVoEmployeeDetailTbl" class="its"  style="width:100%">
    <thead>
        <tr>
    ...
    <tbody>
        <logic:iterate id="employee" name="<%=Constants.LO_VO_EMPLOYEE%>">
            <tr>
                <td>
                    <input type="checkbox" name="loVoEmployeeChk" tabindex="-1" value="<%=((LoVoEmployeeDetailBean) pageContext.getAttribute("employee")).getId()%>">
                    <input type="hidden" name="loVoEmployeeDetailId" value='<bean:write name="employee" property="id"/>'/>
