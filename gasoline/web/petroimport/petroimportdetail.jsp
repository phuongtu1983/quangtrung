        ...
        <tr>
            ...
            <td>
                <logic:equal name="<%=Constants.PETRO_IMPORT%>" property="id" value="0">
                    <html:text property="createdDate" size="30" name="<%=Constants.PETRO_IMPORT%>" styleId="petroImportCreatedDate"/>
                </logic:equal>
                <logic:notEqual name="<%=Constants.PETRO_IMPORT%>" property="id" value="0">
                    <html:text property="createdDate" size="30" name="<%=Constants.PETRO_IMPORT%>" styleId="petroImportCreatedDate" readonly="true"/>
                </logic:notEqual>
            </td>
        </tr>
        <tr>
