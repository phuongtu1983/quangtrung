...
<table class="its" id="saleAccessoryGoodTbl">
    <logic:iterate id="good" name="<%=Constants.SALE_ACCESSORY_GOOD%>">
        <tr>
            ...
            <td><input type="text" size="20" name="quantity" id="detquantity${good.id}" value="0" onblur="return caculateSaleAccessoryListDetail('${good.id}');" onkeyup="try2FloatFormatOnKeyUp(this, event);" onkeypress="return readonlyFloat(event);"/></td>
            <td><input type="text" size="20" name="price" id="detprice${good.id}" value="${good.price}" onblur="return caculateSaleAccessoryListDetail('${good.id}');" onkeyup="try2FloatFormatOnKeyUp(this,event);" onkeypress="return readonlyFloat(event);"/></td>
