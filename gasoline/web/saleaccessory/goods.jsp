...
<table class="its" id="saleAccessoryGoodTbl">
    <logic:iterate id="good" name="<%=Constants.SALE_ACCESSORY_GOOD%>">
        <tr>
            ...
            <td><input type="text" size="20" name="price" id="detprice${good.id}" value="${good.price}" onblur="return caculateSaleAccessoryListDetail('${good.id}');" onkeypress="return readonlyFloat(event);"/></td>
