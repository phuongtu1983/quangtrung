...
<form name="saleAccessoryForm">
    <table style="width: 100%">
        <tr>
            ...
            <td width="160"><html:text property="code" size="30" name="<%=Constants.SALE_ACCESSORY%>" readonly="true" tabindex="-1"/></td>
            <td width="170"  style="padding-right: 20px;padding-left: 10px"><bean:message key="date.title"/></td>
            <td><html:text property="createdDate" size="30" name="<%=Constants.SALE_ACCESSORY%>" styleId="saleAccessoryCreatedDate" tabindex="-1"/></td>
        </tr>
        <tr>
            <td height="30" style="padding-right: 20px""><bean:message key="account.title"/></td>
            <td>
                <html:select property="accountId" name="<%=Constants.SALE_ACCESSORY%>" style="width:195px" tabindex="0">
            ...
            <td><html:text property="total" size="30" name="<%=Constants.SALE_ACCESSORY%>" readonly="true" tabindex="-1"/></td>
        </tr>
        <tr>
            ...
            <td><html:text property="totalPay" size="30" name="<%=Constants.SALE_ACCESSORY%>" readonly="true" tabindex="-1"/></td>
        </tr>
        <tr>
            ...
            <td><html:text property="debt" size="30" name="<%=Constants.SALE_ACCESSORY%>" readonly="true" tabindex="-1"/></td>
        </tr>
        <tr>
            ...
            <td colspan="4">
                <fieldset>
                    ...
                    <table>
                        <tr>
                            <td>
                                <button class="i_cross icon small red" onclick="return delTableRow('saleAccessoryForm', 'saleAccessoryChangeGoodChk', 'saleAccessoryChangeGoodDetailTbl');" tabindex="-1"><bean:message key="message.del"/></button>
                                <button class="i_plus icon small green" onclick="return addSaleAccessoryChangeGood();" tabindex="-1"><bean:message key="message.add"/></button>
                            </td>
                            <td>
