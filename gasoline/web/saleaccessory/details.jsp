    ...
    <tbody>
        <logic:iterate id="good" name="<%=Constants.SALE_ACCESSORY_GOOD%>">
            <tr>
                ...
                <td><input type="text" size="20" name="price" value="${good.price}" id="detprice${good.accessoryId}" onblur="return caculateSaleAccessoryListDetail('${good.accessoryId}');" onkeypress="return readonlyFloat(event);" tabindex="-1"/></td>
                <td><input type="text" size="20" name="amount" value="${good.amount}" id="detamount${good.accessoryId}" readonly="readonly" tabindex="-1"/></td>
            </tr>
        </logic:iterate>
    </tbody>
</table>