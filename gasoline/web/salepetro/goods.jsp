...
<table class="its" id="salePetroGoodTbl">
    <logic:iterate id="good" name="<%=Constants.SALE_PETRO_GOOD%>">
        <tr>
            ...
            <td><input type="text" size="20" name="quantity" id="detquantity${good.id}" value="0" onblur="return caculateFormListDetail('${good.id}','salePetroForm');" onkeypress="return readonlyFloat(event);"/></td>
            <td><input type="text" size="20" name="price" id="detprice${good.id}" value="${good.price}" onblur="return caculateFormListDetail('${good.id}','salePetroForm');" onkeypress="return readonlyFloat(event);" tabindex="-1"/></td>
