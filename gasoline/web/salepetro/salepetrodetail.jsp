...
<form name="salePetroForm">
    <table style="width: 100%">
        ...
        <tr>
            ...
            <td><html:text property="discount" size="30" name="<%=Constants.SALE_PETRO%>" onblur="return formPaidDiscountChanged('salePetroForm');" onkeyup="try2FloatFormatOnKeyUp(this,event);" onkeypress="return readonlyFloat(event);"/></td>
        ...
        <tr>
            ...
            <td><html:text property="paid" size="30" name="<%=Constants.SALE_PETRO%>" onblur="return formPaidDiscountChanged('salePetroForm');" onkeyup="try2FloatFormatOnKeyUp(this,event);" onkeypress="return readonlyFloat(event);"/></td>
