        ...
        <tr>
            ...
            <td>
                <logic:equal name="<%=Constants.SHELL_RETURN%>" property="id" value="0">
                    <html:text property="createdDate" size="30" name="<%=Constants.SHELL_RETURN%>" styleId="shellReturnCreatedDate"/>
                </logic:equal>
                <logic:notEqual name="<%=Constants.SHELL_RETURN%>" property="id" value="0">
                    <html:text property="createdDate" size="30" name="<%=Constants.SHELL_RETURN%>" styleId="shellReturnCreatedDate" readonly="true"/>
                </logic:notEqual>
            </td>
        </tr>
        <tr>
