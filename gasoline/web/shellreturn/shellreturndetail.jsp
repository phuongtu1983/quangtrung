...
<form name="shellReturnForm">
    <table style="width: 100%">
        <tr>
            ...
            <td><html:text property="createdDate" size="30" name="<%=Constants.SHELL_RETURN%>" styleId="shellReturnCreatedDate" readonly="true"/></td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="4" align="center" height="50">
                ...
                <logic:greaterThan name="<%=Constants.SHELL_RETURN%>" property="id" value="0">
