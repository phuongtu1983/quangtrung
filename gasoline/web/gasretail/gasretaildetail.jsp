...
<form name="gasRetailForm">
    <table style="width: 100%">
        ...
        <tr>
            ...
            <td><html:text property="discount" size="30" name="<%=Constants.GAS_RETAIL%>" onblur="return formPaidDiscountChanged('gasRetailForm');" onkeypress="return readonlyFloat(event);"/></td>
        ...
        <tr>
            ...
            <td><html:text property="paid" size="30" name="<%=Constants.GAS_RETAIL%>" onblur="return formPaidDiscountChanged('gasRetailForm');" onkeypress="return readonlyFloat(event);"/></td>
