...
<table class="its" id="gasRetailShellTbl">
    <logic:iterate id="shell" name="<%=Constants.GAS_RETAIL_SHELL%>">
        <tr>
            ...
            <td><input type="text" size="20" name="quantity" id="detquantity${shell.shellId}" value="0" onblur="return caculateFormListDetail('${shell.shellId}','gasRetailForm');" onkeypress="return readonlyFloat(event);"/></td>
            <td><input type="text" size="20" name="price" id="detprice${shell.shellId}" value="0" onblur="return caculateFormListDetail('${shell.shellId}','gasRetailForm');" onkeypress="return readonlyFloat(event);"/></td>
