...
<table class="its" id="saleOilOilTbl">
    <logic:iterate id="oil" name="<%=Constants.SALE_OIL_OIL%>">
        <tr>
            ...
            <td><input type="text" size="20" name="quantity" id="detquantity${oil.oilId}" value="0" onblur="return caculateFormListDetail('${oil.oilId}', 'saleOilForm');" onkeypress="return readonlyFloat(event);"/></td>
            <td><input type="text" size="20" name="price" id="detprice${oil.oilId}" value="${oil.price}" onblur="return caculateFormListDetail('${oil.oilId}', 'saleOilForm');" onkeypress="return readonlyFloat(event);"/></td>
