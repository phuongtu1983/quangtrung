<%@ page import="com.stepup.gasoline.qt.bean.SaleOilPromotionMaterialDetailBean"%>
<%@ page import="com.stepup.gasoline.qt.util.Constants"%>
<%@ taglib uri="/WEB-INF/struts-logic.tld" prefix="logic" %>
<%@ taglib uri="/WEB-INF/struts-bean.tld" prefix="bean" %>
<table id="saleOilPromotionMaterialDetailTbl" class="its"  style="width:100%">
    <thead>
        <tr>
    ...
    <tbody>
        <logic:iterate id="promotionMaterial" name="<%=Constants.SALE_OIL_PROMOTION_MATERIAL%>">
            <tr>
                <td>
                    <input type="checkbox" name="saleOilPromotionMaterialChk" tabindex="-1" value="<%=((SaleOilPromotionMaterialDetailBean) pageContext.getAttribute("promotionMaterial")).getId()%>">
                    <input type="hidden" name="saleOilPromotionMaterialDetailId" value='<bean:write name="promotionMaterial" property="id"/>'/>
