    ...
    <tbody>
        <logic:iterate id="good" name="<%=Constants.GAS_RETURN_GOOD%>">
            <tr>
                ...
                <td><input type="text" size="20" name="quantity" value="${good.quantity}" id="detquantity${good.id}" onblur="return caculateFormListDetail('${good.id}','gasReturnForm');" onkeypress="return readonlyFloat(event);"/></td>
                <td><input type="text" size="20" name="price" value="${good.price}" id="detprice${good.id}" onblur="return caculateFormListDetail('${good.id}','gasReturnForm');" onkeypress="return readonlyFloat(event);"/></td>
