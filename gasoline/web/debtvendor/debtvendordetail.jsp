            ...
            <tr><td>
                    <table cellspacing="0" cellpadding="0" style="border-width: 0px">
                        ...
                        <tr>
                            ...
                            <td><html:text property="paid" size="30" name="<%=Constants.DEBT_VENDOR%>" onkeyup="try2FloatFormatOnKeyUp(this,event);" onkeypress="return readonlyFloat(event);"/></td>
                        </tr>
                        <tr>
            ...
            <tr>
                <td align="center">
                    <p style="margin-top: 0; margin-bottom: 0">
                        ...
                        <logic:greaterThan name="<%=Constants.DEBT_VENDOR%>" property="id" value="0">
