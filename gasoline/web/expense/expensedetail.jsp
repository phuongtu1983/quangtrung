            ...
            <tr><td>
                    <table cellspacing="0" cellpadding="0" style="border-width: 0px">
                        <tr>
                            ...
                            <td><html:text property="code" size="30" name="<%=Constants.EXPENSE%>" readonly="true" tabindex="-1"/></td>
                            <td style="padding-right: 20px;padding-left: 10px"><bean:message key="date.title"/></td>
                            <td><html:text property="createdDate" styleId="expenseDate" size="30" name="<%=Constants.EXPENSE%>" tabindex="-1"/></td>
                        </tr>
                        <tr>
                            <td height="30" style="padding-right: 20px"><bean:message key="expense.detail.type.title"/></td>
                            <td>
                                <html:select property="type" name="<%=Constants.EXPENSE%>" style="width:195px" tabindex="-1">
                            ...
                            <td><html:text property="amount" size="30" name="<%=Constants.EXPENSE%>" onblur="tryNumberFormatCurrentcy(this);" onkeypress="return readonlyFloat(event);"  tabindex="0"/></td>
                        </tr>
                        <tr>
