...
<table class="its" id="promotionMaterialImportPromotionMaterialTbl">
    <logic:iterate id="promotionMaterial" name="<%=Constants.PROMOTION_MATERIAL_IMPORT_PROMOTION_MATERIAL%>">
        <tr>
            ...
            <td><input type="text" size="20" name="quantity" id="detquantity${promotionMaterial.promotionMaterialId}" value="0" onblur="return caculateFormListDetail('${promotionMaterial.promotionMaterialId}','promotionMaterialImportForm');" onkeyup="try2FloatFormatOnKeyUp(this, event);" onkeypress="return readonlyFloat(event);"/></td>
            <td><input type="text" size="20" name="price" id="detprice${promotionMaterial.promotionMaterialId}" value="0" onblur="return caculateFormListDetail('${promotionMaterial.promotionMaterialId}','promotionMaterialImportForm');" onkeyup="try2FloatFormatOnKeyUp(this,event);" onkeypress="return readonlyFloat(event);"/></td>
            <td><input type="text" size="20" name="amount" id="detamount${promotionMaterial.promotionMaterialId}" value="0" readonly="readonly"/></td>
        </tr>
    </logic:iterate>
</table>