...
<form name="promotionMaterialImportForm">
    <table style="width: 100%">
        <tr>
            <td width="160" height="30"><bean:message key="promotionMaterialImport.detail.code"/></td>
        ...
        <tr>
            ...
            <td><html:text property="paid" size="30" name="<%=Constants.PROMOTION_MATERIAL_IMPORT%>" onblur="return promotionMaterialImportPaidChanged();" onkeyup="try2FloatFormatOnKeyUp(this,event);" onkeypress="return readonlyFloat(event);"/></td>
        ...
        <tr>
            ...
            <td>
                <html:select property="paymentMode" name="<%=Constants.PROMOTION_MATERIAL_IMPORT%>" style="width:195px">
