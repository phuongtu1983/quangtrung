...
<table class="its" id="saleSolarPromotionMaterialTbl">
    <logic:iterate id="promotionMaterial" name="<%=Constants.SALE_SOLAR_PROMOTION_MATERIAL%>">
        <tr>
            <td>
                <input type="checkbox" name="saleSolarPromotionMaterialChk" tabindex="-1" value="<bean:write name="promotionMaterial" property="promotionMaterialId"/>">
                <input type="hidden" name="saleSolarPromotionMaterialDetailId" value='0'/>
