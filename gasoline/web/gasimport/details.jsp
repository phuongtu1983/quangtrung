    ...
    <tbody>
        <logic:iterate id="shell" name="<%=Constants.GAS_IMPORT_SHELL%>">
            <tr>
                ...
                <td><input type="text" size="20" name="quantity" value="${shell.quantity}" id="detquantity${shell.shellId}" onblur="return caculateGasImportDetail('${shell.shellId}');" onkeyup="try2FloatFormatOnKeyUp(this,event);" onkeypress="return readonlyFloat(event);"/></td>
                <td><input type="text" size="20" name="price" value="${shell.price}" id="detprice${shell.shellId}" onblur="return caculateGasImportDetail('${shell.shellId}');" onkeyup="try2FloatFormatOnKeyUp(this,event);" onkeypress="return readonlyFloat(event);"/></td>
