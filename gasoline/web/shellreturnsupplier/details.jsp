<%@ page import="com.stepup.gasoline.qt.bean.ShellReturnSupplierDetailBean"%>
<%@ page import="com.stepup.gasoline.qt.util.Constants"%>
<%@ taglib uri="/WEB-INF/struts-logic.tld" prefix="logic" %>
<%@ taglib uri="/WEB-INF/struts-bean.tld" prefix="bean" %>
<table id="shellReturnSupplierDetailTbl" class="its"  style="width:100%">
    <thead>
        <tr>
    ...
    <tbody>
        <logic:iterate id="shell" name="<%=Constants.SHELL_RETURN_SUPPLIER_SHELL%>">
            <tr>
                <td>
                    <input type="checkbox" name="shellReturnSupplierShellChk" tabindex="-1" value="<%=((ShellReturnSupplierDetailBean) pageContext.getAttribute("shell")).getId()%>">
                    <input type="hidden" name="shellReturnSupplierDetailId" value='<bean:write name="shell" property="id"/>'/>
