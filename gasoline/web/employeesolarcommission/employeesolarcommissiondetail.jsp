...
<div id="employeeSolarCommissionFormshowHelpHideDivContent">
    <form name="employeeSolarCommissionForm">
        <table width="100%" cellspacing="0" cellpadding="0" >
            <tr><td>
                    <table cellspacing="0" cellpadding="0" style="border-width: 0px">
                        <tr>
                            <td height="30"><bean:message key="employeeSolarCommission.detail.name"/></td>
                            <td><html:text property="name" size="40" name="<%=Constants.EMPLOYEE_SOLAR_COMMISSION%>"/></td>
                        </tr>
                        <tr>
                            <td height="30"><bean:message key="employeeSolarCommission.detail.amount"/></td>
                            <td><html:text property="amount" size="40" name="<%=Constants.EMPLOYEE_SOLAR_COMMISSION%>" onblur="tryNumberFormatCurrentcy(this);" onkeypress="return readonlyFloat(event);"/></td>
                        </tr>
                        <tr>
                            <td height="30"><bean:message key="note.title"/></td>
                            <td><html:text property="note" size="40" name="<%=Constants.EMPLOYEE_SOLAR_COMMISSION%>"/></td>
                        </tr>
                    </table>
                </td></tr>
            <tr>
                <td align="center">
                    <p style="margin-top: 0; margin-bottom: 0">
                        ...
                        <button class="i_access_denied icon small yellow" onclick="return prepareHidePopup('employeeSolarCommissionFormshowHelpHideDiv');"><bean:message key="message.close"/></button>
                    </p>
                </td>
            </tr>
        </table> 
    ...
    <div id="shiftCFunctionHideDiv" style="display:none">prepareHidePopup('employeeSolarCommissionFormshowHelpHideDiv')</div>
    <div id="shiftSFunctionHideDiv" style="display:none">saveEmployeeSolarCommission()</div>
    <div id="shiftEscFunctionHideDiv" style="display:none">prepareHidePopup('employeeSolarCommissionFormshowHelpHideDiv')</div>
</div>