        ...
        try {
            ...
            if (list != null) {
                ...
                for (int i = 0; i < length; i++) {
                    ...
                    buff.append("<cell>").append(StringUtil.encodeString(bean.getName())).append("^javascript:getEmployeeOilCommission(").append(bean.getId()).append(",\"loadEmployeeOilCommissionList\")^_self</cell>");
