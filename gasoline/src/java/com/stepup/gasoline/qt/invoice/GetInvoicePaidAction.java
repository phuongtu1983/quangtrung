 ...
 * @author phuongtu
 */
public class GetInvoicePaidAction extends SpineAction {
    ...
    public boolean doAction(ActionMapping mapping, ActionForm form,
        ...
        InvoicePaidDetailBean paidDetailBean = new InvoicePaidDetailBean();
        paidDetailBean.setPaidDate(request.getParameter("paidDate"));
        arrDetail.add(paidDetailBean);
        request.setAttribute(Constants.INVOICE_PAID_DETAIL, arrDetail);
