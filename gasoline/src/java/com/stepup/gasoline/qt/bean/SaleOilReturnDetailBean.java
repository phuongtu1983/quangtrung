 ...
 * @author phuongtu
 */
public class SaleOilReturnDetailBean {

    private int id;
    private int saleOilReturnId;
    private int saleOilDetailId;
    private int oilId;
    ...
    public int getSaleOilReturnId() {
        return saleOilReturnId;
    }

    public void setSaleOilReturnId(int saleOilReturnId) {
        this.saleOilReturnId = saleOilReturnId;
    }

    public int getSaleOilDetailId() {
        return saleOilDetailId;
    }

    public void setSaleOilDetailId(int saleOilDetailId) {
