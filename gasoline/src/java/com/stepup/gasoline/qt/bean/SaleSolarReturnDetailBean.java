 ...
 * @author phuongtu
 */
public class SaleSolarReturnDetailBean {

    private int id;
    private int saleSolarReturnId;
    private int saleSolarDetailId;
    private int solarId;
    ...
    public int getSaleSolarReturnId() {
        return saleSolarReturnId;
    }

    public void setSaleSolarReturnId(int saleSolarReturnId) {
        this.saleSolarReturnId = saleSolarReturnId;
    }

    public int getSaleSolarDetailId() {
        return saleSolarDetailId;
    }

    public void setSaleSolarDetailId(int saleSolarDetailId) {
