...
//                    formBean.setFuncView(detBean.getFunction().split(","));
        ...
        perBean.setName(QTUtil.getBundleString("menu.admin.list.title"));
        perBean.setValue(0);
        ...
        perBean = new PermissionViewBean();
        perBean.setCounter("1.1");
        perBean.setLevel(1);
        perBean.setSharedId(1);
        perBean.setName(QTUtil.getBundleString("menu.admin.system.title"));
        perBean.setValue(0);
        perBean.setOperations("");
        arrFun.add(perBean);

        perBean = new PermissionViewBean();
        perBean.setCounter("1.1.1");
        perBean.setLevel(2);
        perBean.setSharedId(1);
        ...
        perBean = new PermissionViewBean();
        perBean.setCounter("1.1.3");
        perBean.setLevel(2);
        perBean.setSharedId(1);
        perBean.setName(QTUtil.getBundleString("permission.title"));
        perBean.setValue(PermissionUtil.PER_PERMISSION);
        perBean.setOperations("," + PermissionUtil.OPERATION_LIST + "," + PermissionUtil.OPERATION_ADD + "," + PermissionUtil.OPERATION_DELETE + "," + PermissionUtil.OPERATION_EDIT + ",");
        arrFun.add(perBean);

        perBean = new PermissionViewBean();
        perBean.setCounter("1.2");
        perBean.setLevel(1);
        perBean.setSharedId(1);
        perBean.setName(QTUtil.getBundleString("menu.admin.organization.title"));
        perBean.setValue(0);
        perBean.setOperations("");
        arrFun.add(perBean);

        perBean = new PermissionViewBean();
        perBean.setCounter("1.2.1");
        perBean.setLevel(2);
        perBean.setSharedId(1);
        ...
        perBean = new PermissionViewBean();
        perBean.setCounter("1.5");
        perBean.setLevel(1);
        perBean.setSharedId(1);
        perBean.setName(QTUtil.getBundleString("menu.admin.solar.title"));
        perBean.setValue(0);
        perBean.setOperations("");
        arrFun.add(perBean);

        perBean = new PermissionViewBean();
        perBean.setCounter("1.5.1");
        perBean.setLevel(2);
        perBean.setSharedId(1);
        perBean.setName(QTUtil.getBundleString("solarGroup.title"));
        perBean.setValue(PermissionUtil.PER_SOLAR_GROUP);
        perBean.setOperations("," + PermissionUtil.OPERATION_LIST + "," + PermissionUtil.OPERATION_ADD + "," + PermissionUtil.OPERATION_EDIT + ",");
        arrFun.add(perBean);

        perBean = new PermissionViewBean();
        perBean.setCounter("1.5.2");
        perBean.setLevel(2);
        perBean.setSharedId(1);
        perBean.setName(QTUtil.getBundleString("solar.title"));
        perBean.setValue(PermissionUtil.PER_SOLAR);
        perBean.setOperations("," + PermissionUtil.OPERATION_LIST + "," + PermissionUtil.OPERATION_ADD + "," + PermissionUtil.OPERATION_EDIT + ",");
        arrFun.add(perBean);

        perBean = new PermissionViewBean();
        perBean.setCounter("1.5.3");
        perBean.setLevel(2);
        perBean.setSharedId(1);
        perBean.setName(QTUtil.getBundleString("employeeSolarCommission.title"));
        perBean.setValue(PermissionUtil.PER_EMPLOYEE_SOLAR_COMMISSION);
        perBean.setOperations("," + PermissionUtil.OPERATION_LIST + "," + PermissionUtil.OPERATION_ADD + "," + PermissionUtil.OPERATION_EDIT + "," + PermissionUtil.OPERATION_DELETE + ",");
        arrFun.add(perBean);

        perBean = new PermissionViewBean();
        perBean.setCounter("1.5.4");
        perBean.setLevel(2);
        perBean.setSharedId(1);
        perBean.setName(QTUtil.getBundleString("saleSolarReturnStore.title"));
        perBean.setValue(PermissionUtil.PER_SALE_SOLAR_RETURN_STORE);
        perBean.setOperations("," + PermissionUtil.OPERATION_ADD + "," + PermissionUtil.OPERATION_EDIT + ",");
        arrFun.add(perBean);

        perBean = new PermissionViewBean();
        perBean.setCounter("1.6");
        perBean.setLevel(1);
        perBean.setSharedId(1);
        ...
        perBean.setName(QTUtil.getBundleString("menu.function.employee.title"));
        perBean.setValue(0);
        perBean.setOperations("," + PermissionUtil.OPERATION_LIST + "," + PermissionUtil.OPERATION_ADD + "," + PermissionUtil.OPERATION_EDIT + "," + PermissionUtil.OPERATION_DELETE + "," + PermissionUtil.OPERATION_PRINT + "," + PermissionUtil.OPERATION_EDIT_PAST + ",");
        arrFun.add(perBean);
        ...
        perBean.setName(QTUtil.getBundleString("menu.function.vehicle.title"));
        perBean.setValue(0);
        perBean.setOperations("," + PermissionUtil.OPERATION_LIST + "," + PermissionUtil.OPERATION_ADD + "," + PermissionUtil.OPERATION_EDIT + "," + PermissionUtil.OPERATION_DELETE + "," + PermissionUtil.OPERATION_PRINT + "," + PermissionUtil.OPERATION_EDIT_PAST + ",");
        arrFun.add(perBean);
        ...
        perBean.setName(QTUtil.getBundleString("menu.function.gas.title"));
        perBean.setOperations("," + PermissionUtil.OPERATION_LIST + "," + PermissionUtil.OPERATION_ADD + "," + PermissionUtil.OPERATION_EDIT + "," + PermissionUtil.OPERATION_DELETE + "," + PermissionUtil.OPERATION_PRINT + "," + PermissionUtil.OPERATION_EDIT_PAST + ",");
        arrFun.add(perBean);

        perBean = new PermissionViewBean();
        perBean.setCounter("4.1");
        perBean.setLevel(2);
        perBean.setSharedId(4);
        ...
        perBean.setName(QTUtil.getBundleString("menu.function.good.title"));
        perBean.setValue(0);
        perBean.setOperations("," + PermissionUtil.OPERATION_LIST + "," + PermissionUtil.OPERATION_ADD + "," + PermissionUtil.OPERATION_EDIT + "," + PermissionUtil.OPERATION_DELETE + "," + PermissionUtil.OPERATION_PRINT + "," + PermissionUtil.OPERATION_EDIT_PAST + ",");
        arrFun.add(perBean);

        perBean = new PermissionViewBean();
        perBean.setCounter("5.1");
        perBean.setLevel(2);
        perBean.setSharedId(5);
        ...
        perBean = new PermissionViewBean();
        perBean.setCounter("5.15");
        perBean.setLevel(2);
        perBean.setSharedId(5);
        perBean.setName(QTUtil.getBundleString("solarImport.title"));
        perBean.setValue(PermissionUtil.PER_SOLAR_IMPORT);
        perBean.setOperations("," + PermissionUtil.OPERATION_LIST + "," + PermissionUtil.OPERATION_ADD + "," + PermissionUtil.OPERATION_EDIT + "," + PermissionUtil.OPERATION_DELETE + "," + PermissionUtil.OPERATION_EDIT_PAST + ",");
        arrFun.add(perBean);

        perBean = new PermissionViewBean();
        perBean.setCounter("5.16");
        perBean.setLevel(2);
        perBean.setSharedId(5);
        perBean.setName(QTUtil.getBundleString("saleSolar.title"));
        perBean.setValue(PermissionUtil.PER_SALE_SOLAR);
        perBean.setOperations("," + PermissionUtil.OPERATION_LIST + "," + PermissionUtil.OPERATION_ADD + "," + PermissionUtil.OPERATION_EDIT + "," + PermissionUtil.OPERATION_DELETE + "," + PermissionUtil.OPERATION_EDIT_PAST + ",");
        arrFun.add(perBean);

        perBean = new PermissionViewBean();
        perBean.setCounter("5.17");
        perBean.setLevel(2);
        perBean.setSharedId(5);
        perBean.setName(QTUtil.getBundleString("solarExport.title"));
        perBean.setValue(PermissionUtil.PER_SOLAR_EXPORT);
        perBean.setOperations("," + PermissionUtil.OPERATION_LIST + "," + PermissionUtil.OPERATION_ADD + "," + PermissionUtil.OPERATION_EDIT + "," + PermissionUtil.OPERATION_DELETE + "," + PermissionUtil.OPERATION_EDIT_PAST + ",");
        arrFun.add(perBean);

        perBean = new PermissionViewBean();
        perBean.setCounter("5.18");
        perBean.setLevel(2);
        perBean.setSharedId(5);
        perBean.setName(QTUtil.getBundleString("saleSolarReturn.title"));
        perBean.setValue(PermissionUtil.PER_SALE_SOLAR_RETURN);
        perBean.setOperations("," + PermissionUtil.OPERATION_LIST + "," + PermissionUtil.OPERATION_ADD + "," + PermissionUtil.OPERATION_EDIT + "," + PermissionUtil.OPERATION_DELETE + "," + PermissionUtil.OPERATION_EDIT_PAST + ",");
        arrFun.add(perBean);
        ...
        perBean.setName(QTUtil.getBundleString("menu.function.payment.title"));
        perBean.setValue(0);
        perBean.setOperations("," + PermissionUtil.OPERATION_LIST + "," + PermissionUtil.OPERATION_ADD + "," + PermissionUtil.OPERATION_EDIT + "," + PermissionUtil.OPERATION_DELETE + "," + PermissionUtil.OPERATION_PRINT + "," + PermissionUtil.OPERATION_EDIT_PAST + ",");
        arrFun.add(perBean);

        perBean = new PermissionViewBean();
        perBean.setCounter("6.1");
        perBean.setLevel(2);
        perBean.setSharedId(6);
        ...
        perBean = new PermissionViewBean();
        perBean.setCounter("6.6");
        perBean.setLevel(2);
        perBean.setSharedId(6);
        perBean.setName(QTUtil.getBundleString("income.title"));
        perBean.setValue(PermissionUtil.PER_INCOME);
        perBean.setOperations("," + PermissionUtil.OPERATION_LIST + "," + PermissionUtil.OPERATION_ADD + "," + PermissionUtil.OPERATION_EDIT + "," + PermissionUtil.OPERATION_DELETE + "," + PermissionUtil.OPERATION_EDIT_PAST + "," + PermissionUtil.OPERATION_PRINT + ",");
        arrFun.add(perBean);

        perBean = new PermissionViewBean();
        perBean.setCounter("6.7");
        perBean.setLevel(2);
        perBean.setSharedId(6);
        ...
        perBean.setName(QTUtil.getBundleString("menu.function.report.title"));
        perBean.setValue(0);
        perBean.setOperations("," + PermissionUtil.OPERATION_PRINT + ",");
        arrFun.add(perBean);

        perBean = new PermissionViewBean();
        perBean.setCounter("7.1");
        perBean.setLevel(1);
        perBean.setSharedId(7);
        perBean.setName(QTUtil.getBundleString("report.gas.title"));
        perBean.setValue(0);
        perBean.setOperations("");
        arrFun.add(perBean);

        perBean = new PermissionViewBean();
        perBean.setCounter("7.1.1");
        perBean.setLevel(2);
        perBean.setSharedId(7);
        ...
        perBean.setLevel(1);
        perBean.setSharedId(7);
        perBean.setName(QTUtil.getBundleString("report.petro.title"));
        perBean.setValue(0);
        perBean.setOperations("");
        arrFun.add(perBean);
        ...
        perBean = new PermissionViewBean();
        perBean.setCounter("7.2.5");
        perBean.setLevel(2);
        perBean.setSharedId(7);
        perBean.setName(QTUtil.getBundleString("report.saleCustomerPetro.title"));
        perBean.setValue(PermissionUtil.PER_REPORT_PETRO_SALE_CUSTOMER);
        perBean.setOperations("," + PermissionUtil.OPERATION_PRINT + ",");
        arrFun.add(perBean);
        ...
        perBean.setLevel(1);
        perBean.setSharedId(7);
        perBean.setName(QTUtil.getBundleString("report.good.title"));
        perBean.setValue(0);
        perBean.setOperations("");
        arrFun.add(perBean);
        ...
        perBean.setLevel(1);
        perBean.setSharedId(7);
        perBean.setName(QTUtil.getBundleString("report.oil.title"));
        perBean.setValue(0);
        perBean.setOperations("");
        arrFun.add(perBean);
        ...
        perBean = new PermissionViewBean();
        perBean.setCounter("7.4.11");
        perBean.setLevel(2);
        perBean.setSharedId(7);
        perBean.setName(QTUtil.getBundleString("report.saleCustomerOil.title"));
        perBean.setValue(PermissionUtil.PER_REPORT_OIL_SALE_CUSTOMER);
        perBean.setOperations("," + PermissionUtil.OPERATION_PRINT + ",");
        arrFun.add(perBean);
        ...
        perBean.setLevel(1);
        perBean.setSharedId(7);
        perBean.setName(QTUtil.getBundleString("report.solar.title"));
        perBean.setValue(0);
        perBean.setOperations("");
        arrFun.add(perBean);
        ...
        perBean = new PermissionViewBean();
        perBean.setCounter("7.5.11");
        perBean.setLevel(2);
        perBean.setSharedId(7);
        perBean.setName(QTUtil.getBundleString("report.saleCustomerSolar.title"));
        perBean.setValue(PermissionUtil.PER_REPORT_SOLAR_SALE_CUSTOMER);
        perBean.setOperations("," + PermissionUtil.OPERATION_PRINT + ",");
        arrFun.add(perBean);
        ...
        perBean.setLevel(1);
        perBean.setSharedId(7);
        perBean.setName(QTUtil.getBundleString("report.transport.title"));
        perBean.setValue(0);
        perBean.setOperations("");
        arrFun.add(perBean);
        ...
        perBean.setLevel(1);
        perBean.setSharedId(7);
        perBean.setName(QTUtil.getBundleString("report.accountant.title"));
        perBean.setValue(0);
        perBean.setOperations("");
        arrFun.add(perBean);
        ...
        perBean = new PermissionViewBean();
        perBean.setCounter("7.7.6");
        perBean.setLevel(2);
        perBean.setSharedId(7);
        perBean.setName(QTUtil.getBundleString("report.cashbookmodule.title"));
        perBean.setValue(PermissionUtil.PER_REPORT_CASH_BOOK_MODULE);
        perBean.setOperations("," + PermissionUtil.OPERATION_PRINT + ",");
        arrFun.add(perBean);
