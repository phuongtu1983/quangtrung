        ...
        try {
            ...
            if (list != null) {
                ...
                for (int i = 0; i < length; i++) {
                    ...
                    buff.append("<cell>").append(StringUtil.encodeString(bean.getOrganizationName())).append("^javascript:getVendorOrganization(").append(bean.getId()).append(",\"loadVendorOrganizationList\")^_self</cell>");
