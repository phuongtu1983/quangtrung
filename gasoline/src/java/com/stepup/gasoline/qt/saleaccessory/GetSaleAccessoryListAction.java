 ...
 * @author phuongtu
 */
public class GetSaleAccessoryListAction extends Action {
        ...
        try {
            ...
            if (importList != null) {
                ...
                for (int i = 0; i < length; i++) {
                    SaleAccessoryFormBean bean = (SaleAccessoryFormBean) importList.get(i);
                    buff.append("<row id=\"").append(bean.getId()).append("\">");
                    buff.append("<cell>").append(bean.getCode()).append("^javascript:getSaleAccessory(").append(bean.getId()).append(")^_self</cell>");
