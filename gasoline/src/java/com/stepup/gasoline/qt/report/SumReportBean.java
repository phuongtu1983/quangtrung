...
public class SumReportBean {
    ...
    private int shell12Return;
    private int shell45Return;
    private int sell12;
    private int sell45;
    private int shell12Diff;
    private int shell45Diff;
    ...
    public int getShell12Return() {
        return shell12Return;
    }

    public void setShell12Return(int shell12Return) {
        this.shell12Return = shell12Return;
    }

    public int getShell45Return() {
        return shell45Return;
    }

    public void setShell45Return(int shell45Return) {
        this.shell45Return = shell45Return;
    }

    public int getSell12() {
        return sell12;
    }

    public void setSell12(int sell12) {
        this.sell12 = sell12;
    }

    public int getSell45() {
        return sell45;
    }

    public void setSell45(int sell45) {
        this.sell45 = sell45;
    }

    public int getShell12Diff() {
        return shell12Diff;
    }

    public void setShell12Diff(int shell12Diff) {
        this.shell12Diff = shell12Diff;
    }

    public int getShell45Diff() {
        return shell45Diff;
    }

    public void setShell45Diff(int shell45Diff) {
        this.shell45Diff = shell45Diff;
    }
