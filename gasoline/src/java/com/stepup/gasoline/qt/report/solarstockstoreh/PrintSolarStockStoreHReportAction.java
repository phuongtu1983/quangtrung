 ...
 */
package com.stepup.gasoline.qt.report.solarstockstoreh;
 ...
 * @author phuongtu
 */
public class PrintSolarStockStoreHReportAction extends BaseAction {
    ...
    public boolean doAction(ActionMapping mapping, ActionForm form,
        ...
        try {
            ...
            String templateFileName = "so_theo_doi_nxt_tong_hop_solar_store_h";
            String sourceFile = request.getSession().getServletContext().getRealPath("/templates/" + templateFileName + ".xls");
            ReportDAO reportDAO = new ReportDAO();
            ArrayList list = reportDAO.getSolarStockStoreHReport(fromDate, toDate, organizationIds, storeId);
            if (list == null) {
                list = new ArrayList();
            }
