 ...
 */
package com.stepup.gasoline.qt.report.comparegood;
 ...
 * @author phuongtu
 */
public class PrintCompareGoodReportAction extends BaseAction {
    ...
    public boolean doAction(ActionMapping mapping, ActionForm form,
        ...
        try {
            ...
            ArrayList list = null;
            CompareGoodReportOutBean outBean = new CompareGoodReportOutBean();
            ...
            String templateFileName = request.getSession().getServletContext().getRealPath("/templates/doi_chieu_hang_hoa.xls");
    ...
    private ArrayList printCompareReport(String fromDate, String toDate, int customerId, String organizationIds, CompareGoodReportOutBean outBean) {
        ArrayList list = null;
        try {
            ...
            list = reportDAO.getCompareGoodReport(fromDate, toDate, organizationIds, customerId, outBean);
        } catch (Exception ex) {
        }
        return list;
    }
