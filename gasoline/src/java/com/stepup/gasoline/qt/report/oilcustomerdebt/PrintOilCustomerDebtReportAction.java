 ...
 * @author phuongtu
 */
public class PrintOilCustomerDebtReportAction extends BaseAction {
    ...
    public boolean doAction(ActionMapping mapping, ActionForm form,
        ...
        try {
            ...
            ArrayList list = null;
            OilCustomerDebtReportOutBean outBean = new OilCustomerDebtReportOutBean();
    ...
    private ArrayList printOilCustomerDebtReport(String fromDate, String toDate, int customerId, String organizationIds, OilCustomerDebtReportOutBean outBean) {
        ArrayList list = null;
        try {
            ...
            list = reportDAO.getOilCustomerDebtReport(fromDate, toDate, organizationIds, customerId, outBean);
        } catch (Exception ex) {
        }
        return list;
    }
