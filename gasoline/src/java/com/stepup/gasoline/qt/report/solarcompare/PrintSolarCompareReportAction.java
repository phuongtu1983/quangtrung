 ...
 * @author phuongtu
 */
public class PrintSolarCompareReportAction extends BaseAction {
    ...
    public boolean doAction(ActionMapping mapping, ActionForm form,
        ...
        try {
            ...
            ArrayList list = null;
            SolarCompareReportOutBean outBean = new SolarCompareReportOutBean();
            list = printSolarCompareReport(fromDate, toDate, customerId, organizationIds, outBean);
            ...
            exporter.export(request, response, templateFileName, "report_solar_compare.xls");
        } catch (Exception ex) {
    ...
    private ArrayList printSolarCompareReport(String fromDate, String toDate, int customerId, String organizationIds, SolarCompareReportOutBean outBean) {
        ArrayList list = null;
        try {
            ...
            list = reportDAO.getSolarCompareReport(fromDate, toDate, organizationIds, customerId, outBean);
        } catch (Exception ex) {
        }
        return list;
    }
