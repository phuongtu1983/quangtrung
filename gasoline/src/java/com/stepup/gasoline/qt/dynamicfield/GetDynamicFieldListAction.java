        ...
        try {
            ...
            if (list != null) {
                ...
                for (int i = 0; i < length; i++) {
                    ...
                    buff.append("<cell>").append(StringUtil.encodeString(bean.getName())).append("^javascript:getDynamicField(").append(bean.getId()).append(",\"loadDynamicFieldList\")^_self</cell>");
