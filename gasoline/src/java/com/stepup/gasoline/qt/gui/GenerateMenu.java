    ...
    public void generate(int memberId) {
        try {
            ...
            if (isHasPermission(PermissionUtil.OPERATION_LIST + "," + PermissionUtil.OPERATION_ADD,
                    ...
                    + "," + PermissionUtil.PER_DAY_OFF + "," + PermissionUtil.PER_OTHER_BONUS + "," + PermissionUtil.PER_PANELTY)) {
            ...
            if (isHasPermission(PermissionUtil.OPERATION_LIST + "," + PermissionUtil.OPERATION_ADD,
                    PermissionUtil.PER_VENDOR + "," + PermissionUtil.PER_UNIT_RATE + "," + PermissionUtil.PER_AGENCY + "," + PermissionUtil.PER_OIL_GROUP
                    + "," + PermissionUtil.PER_OIL + "," + PermissionUtil.PER_EMPLOYEE_OIL_COMMISSION + "," + PermissionUtil.PER_SALE_OIL_RETURN_STORE)) {
            ...
            if (isHasPermission(PermissionUtil.OPERATION_LIST + "," + PermissionUtil.OPERATION_ADD,
                    PermissionUtil.PER_VENDOR + "," + PermissionUtil.PER_SOLAR_GROUP + "," + PermissionUtil.PER_SOLAR
                    + "," + PermissionUtil.PER_EMPLOYEE_SOLAR_COMMISSION + "," + PermissionUtil.PER_SALE_SOLAR_RETURN_STORE)) {
                ...
                if (isHasPermission(PermissionUtil.OPERATION_LIST + "," + PermissionUtil.OPERATION_EDIT, PermissionUtil.PER_VENDOR)) {
                    ...
                    if (isHasPermission(PermissionUtil.OPERATION_LIST, PermissionUtil.PER_VENDOR)) {
                        buffTemp.append("<item id=\"vendorsolarlist\" text=\"").append(QTUtil.getBundleString("vendor.list.title")).append("\"/>");//list vendorsolar
                    }
                    if (isHasPermission(PermissionUtil.OPERATION_EDIT, PermissionUtil.PER_VENDOR)) {
                ...
                if (isHasPermission(PermissionUtil.OPERATION_LIST + "," + PermissionUtil.OPERATION_ADD, PermissionUtil.PER_SOLAR_GROUP)) {
                    ...
                    if (isHasPermission(PermissionUtil.OPERATION_LIST, PermissionUtil.PER_SOLAR_GROUP)) {
                        buffTemp.append("<item id=\"solargrouplist\" text=\"").append(QTUtil.getBundleString("solarGroup.list.title")).append("\"/>");//list solar group
                    }
                    if (isHasPermission(PermissionUtil.OPERATION_ADD, PermissionUtil.PER_SOLAR_GROUP)) {
                        buffTemp.append("<item id=\"solargroupadd\" text=\"").append(QTUtil.getBundleString("solarGroup.detail.add.title")).append("\"/>");//add solar group
                    }
                    buffTemp.append("</item>");//end solar groups
                }
                if (isHasPermission(PermissionUtil.OPERATION_LIST + "," + PermissionUtil.OPERATION_ADD, PermissionUtil.PER_SOLAR)) {
                    buffTemp.append("<item id=\"solars\" complex=\"true\" text=\"").append(QTUtil.getBundleString("solar.title")).append("\">");//start solar
                    if (isHasPermission(PermissionUtil.OPERATION_LIST, PermissionUtil.PER_SOLAR)) {
                        buffTemp.append("<item id=\"solarlist\" text=\"").append(QTUtil.getBundleString("solar.list.title")).append("\"/>");//list solar
                    }
                    if (isHasPermission(PermissionUtil.OPERATION_ADD, PermissionUtil.PER_SOLAR)) {
                        buffTemp.append("<item id=\"solaradd\" text=\"").append(QTUtil.getBundleString("solar.detail.add.title")).append("\"/>");//add solar
                    }
                    buffTemp.append("</item>");//end solars
                }
                if (isHasPermission(PermissionUtil.OPERATION_LIST + "," + PermissionUtil.OPERATION_ADD, PermissionUtil.PER_EMPLOYEE_SOLAR_COMMISSION)) {
                    buffTemp.append("<item id=\"employeesolarcommissions\" complex=\"true\" text=\"").append(QTUtil.getBundleString("employeeSolarCommission.title")).append("\">");
                    if (isHasPermission(PermissionUtil.OPERATION_LIST, PermissionUtil.PER_EMPLOYEE_SOLAR_COMMISSION)) {
                        buffTemp.append("<item id=\"employeesolarcommissionlist\" text=\"").append(QTUtil.getBundleString("employeeSolarCommission.list.title")).append("\"/>");
                    }
                    if (isHasPermission(PermissionUtil.OPERATION_ADD, PermissionUtil.PER_EMPLOYEE_SOLAR_COMMISSION)) {
                        buffTemp.append("<item id=\"employeesolarcommissionadd\" text=\"").append(QTUtil.getBundleString("employeeSolarCommission.detail.add.title")).append("\"/>");
                    }
                    buffTemp.append("</item>");
                }
                if (isHasPermission(PermissionUtil.OPERATION_ADD + "," + PermissionUtil.OPERATION_ADD, PermissionUtil.PER_SALE_SOLAR_RETURN_STORE)) {
                    buffTemp.append("<item id=\"salesolarreturnstores\" complex=\"true\" text=\"").append(QTUtil.getBundleString("saleSolarReturnStore.title")).append("\">");//start saleSolarReturnStore
                    if (isHasPermission(PermissionUtil.OPERATION_ADD, PermissionUtil.PER_UNIT_RATE)) {
                        buffTemp.append("<item id=\"salesolarreturnstoreadd\" text=\"").append(QTUtil.getBundleString("saleSolarReturnStore.detail.add.title")).append("\"/>");//add saleSolarReturnStore
                    }
                    buffTemp.append("</item>");//end saleSolarReturnStore
                }
            ...
            if (isHasPermission(PermissionUtil.OPERATION_LIST + "," + PermissionUtil.OPERATION_ADD,
                    PermissionUtil.PER_EMPLOYEE_ADVANCE + "," + PermissionUtil.PER_BORROW + "," + PermissionUtil.PER_EMPLOYEE_TIMESHEET + "," + PermissionUtil.PER_EMPLOYEE_OFF
                    + "," + PermissionUtil.PER_EMPLOYEE_OFF_INCREASE + "," + PermissionUtil.PER_EMPLOYEE_OFF_MONEY + "," + PermissionUtil.PER_EMPLOYEE_OTHER_BONUS
                    + "," + PermissionUtil.PER_EMPLOYEE_PANELTY + "," + PermissionUtil.PER_SALARY)) {
                ...
                if (isHasPermission(PermissionUtil.OPERATION_LIST + "," + PermissionUtil.OPERATION_ADD, PermissionUtil.PER_EMPLOYEE_PANELTY)) {
                    buffTemp.append("<item id=\"employeepaneltys\" complex=\"true\" text=\"").append(QTUtil.getBundleString("panelty.title")).append("\">");
                    if (isHasPermission(PermissionUtil.OPERATION_LIST, PermissionUtil.PER_EMPLOYEE_PANELTY)) {
                        buffTemp.append("<item id=\"employeepaneltylist\" text=\"").append(QTUtil.getBundleString("panelty.list.title")).append("\"/>");
                    }
                    if (isHasPermission(PermissionUtil.OPERATION_ADD, PermissionUtil.PER_EMPLOYEE_PANELTY)) {
            ...
            buffTemp = new StringBuilder();
            if (isHasPermission(PermissionUtil.OPERATION_LIST + "," + PermissionUtil.OPERATION_ADD,
                    PermissionUtil.PER_TRIP_FEE + "," + PermissionUtil.PER_TRIP_OIL + "," + PermissionUtil.PER_EMPLOYEE_ROUTE_FEE + "," + PermissionUtil.PER_VEHICLE_OUT
                    + "," + PermissionUtil.PER_VEHICLE_IN + "," + PermissionUtil.PER_EXPORT_WHOLESALE + "," + PermissionUtil.PER_TRANSPORT_SERVICE)) {
            ...
            if (isHasPermission(PermissionUtil.OPERATION_LIST + "," + PermissionUtil.OPERATION_ADD,
                    ...
                    + "," + PermissionUtil.PER_SALE_INNER + "," + PermissionUtil.PER_SALE_SHELL + "," + PermissionUtil.PER_OLD_SHELL + "," + PermissionUtil.PER_SHELL_RETURN
...
//                }
            ...
            buffTemp = new StringBuilder();
            if (isHasPermission(PermissionUtil.OPERATION_LIST + "," + PermissionUtil.OPERATION_ADD,
                    PermissionUtil.PER_PETRO_IMPORT + "," + PermissionUtil.PER_SALE_PETRO + "," + PermissionUtil.PER_OIL_IMPORT + "," + PermissionUtil.PER_SALE_OIL
                    + "," + PermissionUtil.PER_OIL_EXPORT + "," + PermissionUtil.PER_SALE_OIL_RETURN + "," + PermissionUtil.PER_GOOD_IMPORT
                    + "," + PermissionUtil.PER_SALE_GOOD + "," + PermissionUtil.PER_SHIELD_IMPORT + "," + PermissionUtil.PER_SHIELD_DECREASE
                    + "," + PermissionUtil.PER_ACCESSORY_IMPORT + "," + PermissionUtil.PER_SALE_ACCESSORY + "," + PermissionUtil.PER_PROMOTION_MATERIAL_IMPORT
                    + "," + PermissionUtil.PER_FIXED_ASSET_DEPRECIATION + "," + PermissionUtil.PER_SOLAR_IMPORT + "," + PermissionUtil.PER_SALE_SOLAR
                    + "," + PermissionUtil.PER_SOLAR_EXPORT + "," + PermissionUtil.PER_SALE_SOLAR_RETURN)) {
                ...
                if (isHasPermission(PermissionUtil.OPERATION_LIST + "," + PermissionUtil.OPERATION_ADD, PermissionUtil.PER_SOLAR_IMPORT)) {
                    buffTemp.append("<item id=\"solarimports\" complex=\"true\" text=\"").append(QTUtil.getBundleString("solarImport.title")).append("\">");
                    if (isHasPermission(PermissionUtil.OPERATION_LIST, PermissionUtil.PER_SOLAR_IMPORT)) {
                        buffTemp.append("<item id=\"solarimportlist\" text=\"").append(QTUtil.getBundleString("solarImport.list.title")).append("\"/>");
                    }
                    if (isHasPermission(PermissionUtil.OPERATION_ADD, PermissionUtil.PER_SOLAR_IMPORT)) {
                        buffTemp.append("<item id=\"solarimportadd\" text=\"").append(QTUtil.getBundleString("solarImport.detail.add.title")).append("\"/>");
                    }
                    buffTemp.append("</item>");
                }
                if (isHasPermission(PermissionUtil.OPERATION_LIST + "," + PermissionUtil.OPERATION_ADD, PermissionUtil.PER_SALE_SOLAR)) {
                    buffTemp.append("<item id=\"salesolars\" complex=\"true\" text=\"").append(QTUtil.getBundleString("saleSolar.title")).append("\">");
                    if (isHasPermission(PermissionUtil.OPERATION_LIST, PermissionUtil.PER_SALE_SOLAR)) {
                        buffTemp.append("<item id=\"salesolarlist\" text=\"").append(QTUtil.getBundleString("saleSolar.list.title")).append("\"/>");
                    }
                    if (isHasPermission(PermissionUtil.OPERATION_ADD, PermissionUtil.PER_SALE_SOLAR)) {
                        buffTemp.append("<item id=\"salesolaradd\" text=\"").append(QTUtil.getBundleString("saleSolar.detail.add.title")).append("\"/>");
                    }
                    buffTemp.append("</item>");
                }
                if (isHasPermission(PermissionUtil.OPERATION_LIST + "," + PermissionUtil.OPERATION_ADD, PermissionUtil.PER_SOLAR_EXPORT)) {
                    buffTemp.append("<item id=\"solarexports\" complex=\"true\" text=\"").append(QTUtil.getBundleString("solarExport.title")).append("\">");
                    if (isHasPermission(PermissionUtil.OPERATION_LIST, PermissionUtil.PER_SOLAR_EXPORT)) {
                        buffTemp.append("<item id=\"solarexportlist\" text=\"").append(QTUtil.getBundleString("solarExport.list.title")).append("\"/>");
                    }
                    buffTemp.append("</item>");
                }
                if (isHasPermission(PermissionUtil.OPERATION_LIST + "," + PermissionUtil.OPERATION_ADD, PermissionUtil.PER_SALE_SOLAR_RETURN)) {
                    buffTemp.append("<item id=\"salesolarreturns\" complex=\"true\" text=\"").append(QTUtil.getBundleString("saleSolarReturn.title")).append("\">");
                    if (isHasPermission(PermissionUtil.OPERATION_LIST, PermissionUtil.PER_SALE_SOLAR_RETURN)) {
                        buffTemp.append("<item id=\"salesolarreturnlist\" text=\"").append(QTUtil.getBundleString("saleSolarReturn.list.title")).append("\"/>");
                    }
                    buffTemp.append("</item>");
                }
            }
            ...
            buffTemp = new StringBuilder();
            if (isHasPermission(PermissionUtil.OPERATION_LIST + "," + PermissionUtil.OPERATION_ADD,
                    PermissionUtil.PER_CONTRACT + "," + PermissionUtil.PER_INVOICE + "," + PermissionUtil.PER_INVOICE_SOLAR + "," + PermissionUtil.PER_DEBT_VENDOR
                    + "," + PermissionUtil.PER_DEBT_WHOLESALE + "," + PermissionUtil.PER_INCOME + "," + PermissionUtil.PER_EXPENSE + "," + PermissionUtil.PER_DEBT_ADJUSTMENT)) {
...
//                }
            ...
            if (isHasPermission(PermissionUtil.OPERATION_PRINT + "", PermissionUtil.PER_REPORT_LPG_IMPORT + "," + PermissionUtil.PER_REPORT_VENDOR_DEBT
                    ...
                    + "," + PermissionUtil.PER_REPORT_SUM + "," + PermissionUtil.PER_REPORT_COMPARE + "," + PermissionUtil.PER_REPORT_COMPARE_LPG
                    + "," + PermissionUtil.PER_REPORT_COMPARE_LPG_VENDOR_CUSTOMER + "," + PermissionUtil.PER_REPORT_COMPARE_GAS + "," + PermissionUtil.PER_REPORT_COMPARE_VENDOR
                    + "," + PermissionUtil.PER_REPORT_SALE + "," + PermissionUtil.PER_REPORT_SALE_CUSTOMER + "," + PermissionUtil.PER_REPORT_GAS_COMMISION
                    + "," + PermissionUtil.PER_REPORT_GAS_EMPLOYEE_COMMISION + "," + PermissionUtil.PER_REPORT_SHELL + "," + PermissionUtil.PER_REPORT_PETRO_SALE_CUSTOMER
                    + "," + PermissionUtil.PER_REPORT_OIL_SALE_CUSTOMER + "," + PermissionUtil.PER_REPORT_SOLAR_SALE_CUSTOMER
            )) {
                ...
                if (isHasPermission(PermissionUtil.OPERATION_PRINT, PermissionUtil.PER_REPORT_SHELL)) {
            ...
            if (isHasPermission(PermissionUtil.OPERATION_PRINT + "", PermissionUtil.PER_REPORT_PETRO_IMPORT
                ...
                if (isHasPermission(PermissionUtil.OPERATION_PRINT, PermissionUtil.PER_REPORT_PETRO_SALE_CUSTOMER)) {
                    buffTemp.append("<item id=\"reportpetrosalecustomer\" text=\"").append(QTUtil.getBundleString("report.saleCustomerPetro.title")).append("\"/>");
                }
                buffTemp.append("</item>");
            }
            ...
            if (isHasPermission(PermissionUtil.OPERATION_PRINT + "", PermissionUtil.PER_REPORT_OIL_IMPORT + "," + PermissionUtil.PER_REPORT_OIL_STOCK
                    + "," + PermissionUtil.PER_REPORT_OIL_STOCK_SUM + "," + PermissionUtil.PER_REPORT_OIL_SALE + "," + PermissionUtil.PER_REPORT_OIL_COMPARE
                    + "," + PermissionUtil.PER_REPORT_OIL_COMMISSION_AGENCY + "," + PermissionUtil.PER_REPORT_OIL_COMMISSION_CUSTOMER
                    + "," + PermissionUtil.PER_REPORT_OIL_VENDOR_STOCK + "," + PermissionUtil.PER_REPORT_OIL_VENDOR_DEBT + "," + PermissionUtil.PER_REPORT_OIL_CUSTOMER_DEBT
            )) {
                ...
                if (isHasPermission(PermissionUtil.OPERATION_PRINT, PermissionUtil.PER_REPORT_OIL_SALE_CUSTOMER)) {
                    buffTemp.append("<item id=\"reportoilsalecustomer\" text=\"").append(QTUtil.getBundleString("report.saleCustomerOil.title")).append("\"/>");
                }
                buffTemp.append("</item>");
            }
            if (isHasPermission(PermissionUtil.OPERATION_PRINT + "", PermissionUtil.PER_REPORT_SOLAR_IMPORT + "," + PermissionUtil.PER_REPORT_SOLAR_STOCK
                    + "," + PermissionUtil.PER_REPORT_SOLAR_STOCK_SUM + "," + PermissionUtil.PER_REPORT_SOLAR_SALE + "," + PermissionUtil.PER_REPORT_SOLAR_COMPARE
                    + "," + PermissionUtil.PER_REPORT_SOLAR_COMMISSION_AGENCY + "," + PermissionUtil.PER_REPORT_SOLAR_COMMISSION_CUSTOMER
                    + "," + PermissionUtil.PER_REPORT_SOLAR_VENDOR_STOCK + "," + PermissionUtil.PER_REPORT_SOLAR_VENDOR_DEBT + "," + PermissionUtil.PER_REPORT_SOLAR_CUSTOMER_DEBT
            )) {
                ...
                if (isHasPermission(PermissionUtil.OPERATION_PRINT, PermissionUtil.PER_REPORT_SOLAR_SALE_CUSTOMER)) {
                    buffTemp.append("<item id=\"reportsolarsalecustomer\" text=\"").append(QTUtil.getBundleString("report.saleCustomerSolar.title")).append("\"/>");
                }
                buffTemp.append("</item>");
            }
            if (isHasPermission(PermissionUtil.OPERATION_PRINT + "", PermissionUtil.PER_REPORT_TRANSPORT_FEE + "," + PermissionUtil.PER_REPORT_VEHICLE_FEE
                    + "," + PermissionUtil.PER_REPORT_VEHICLE_SALE + "," + PermissionUtil.PER_REPORT_TRANSPORT_SERVICE)) {
            ...
            if (isHasPermission(PermissionUtil.OPERATION_PRINT + "", PermissionUtil.PER_REPORT_EMPLOYEE_SALARY + "," + PermissionUtil.PER_REPORT_EMPLOYEE_OFF
                    + "," + PermissionUtil.PER_REPORT_EMPLOYEE_WORKING + "," + PermissionUtil.PER_REPORT_EMPLOYEE_VEHICLE_SALARY
                    + "," + PermissionUtil.PER_REPORT_CASH_BOOK + "," + PermissionUtil.PER_REPORT_CASH_BOOK_MODULE)) {
                ...
                if (isHasPermission(PermissionUtil.OPERATION_PRINT, PermissionUtil.PER_REPORT_CASH_BOOK_MODULE)) {
                    buffTemp.append("<item id=\"reportcashbookmodule\" text=\"").append(QTUtil.getBundleString("report.cashbookmodule.title")).append("\"/>");
                }
                buffTemp.append("</item>");
            }
