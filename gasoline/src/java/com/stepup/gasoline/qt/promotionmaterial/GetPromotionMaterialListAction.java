 ...
 * @author phuongtu
 */
public class GetPromotionMaterialListAction extends BaseAction {
    ...
    public boolean doAction(ActionMapping mapping, ActionForm form,
        ...
        try {
            ...
            ArrayList list = goodDAO.getPromotionMaterials(NumberUtil.parseInt(request.getParameter("status"), 0));
            if (list != null) {
