 ...
 * @author phuongtu
 */
public class GetPromotionMaterialImportListAction extends Action {
        ...
        try {
            ...
            if (importList != null) {
                ...
                for (int i = 0; i < length; i++) {
                    PromotionMaterialImportFormBean bean = (PromotionMaterialImportFormBean) importList.get(i);
                    buff.append("<row id=\"").append(bean.getId()).append("\">");
                    buff.append("<cell>").append(bean.getCode()).append("^javascript:getPromotionMaterialImport(").append(bean.getId()).append(")^_self</cell>");
