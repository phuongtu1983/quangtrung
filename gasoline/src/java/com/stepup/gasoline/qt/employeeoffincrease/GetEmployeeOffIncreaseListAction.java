 ...
 * @author phuongtu
 */
public class GetEmployeeOffIncreaseListAction extends BaseAction {
    ...
    public boolean doAction(ActionMapping mapping, ActionForm form,
        ...
        try {
            ...
            ArrayList list = employeeDAO.searchEmployeeOffIncrease(request.getParameter("fromDate"), request.getParameter("toDate"), QTUtil.getOrganizationManageds(request.getSession()));
            if (list != null) {
                int length = list.size();
                for (int i = 0; i < length; i++) {
                    EmployeeOffIncreaseFormBean bean = (EmployeeOffIncreaseFormBean) list.get(i);
