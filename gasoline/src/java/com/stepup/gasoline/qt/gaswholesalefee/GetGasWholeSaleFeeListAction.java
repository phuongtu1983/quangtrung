 ...
 * @author phuongtu
 */
public class GetGasWholeSaleFeeListAction extends BaseAction {
    ...
    public boolean doAction(ActionMapping mapping, ActionForm form,
        ...
        try {
            ...
            ArrayList list = gasDAO.getGasWholeSaleFees(NumberUtil.parseInt(request.getParameter("status"), 0));
            if (list != null) {
