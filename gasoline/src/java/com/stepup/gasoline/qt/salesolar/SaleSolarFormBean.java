 ...
 * @author phuongtu
 */
public class SaleSolarFormBean extends org.apache.struts.action.ActionForm {
    ...
    private String[] saleSolarPromotionMaterialDetailId;
    ...
    public SaleSolarFormBean() {
        this.canEdit = 1;
    }

    public SaleSolarFormBean(SaleSolarBean bean) {
        this.id = bean.getId();
    ...
    public String[] getSaleSolarPromotionMaterialDetailId() {
        return saleSolarPromotionMaterialDetailId;
    }

    public void setSaleSolarPromotionMaterialDetailId(String[] saleSolarPromotionMaterialDetailId) {
        this.saleSolarPromotionMaterialDetailId = saleSolarPromotionMaterialDetailId;
    }
