 ...
 * @author phuongtu
 */
public class SalePetroFormBean extends org.apache.struts.action.ActionForm {
    ...
    public SalePetroFormBean() {
        this.canEdit = 1;
    }

    public SalePetroFormBean(SalePetroBean bean) {
        this.id = bean.getId();
    ...
    public String[] getSalePetroDetailId() {
        return salePetroDetailId;
    }

    public void setSalePetroDetailId(String[] salePetroDetailId) {
        this.salePetroDetailId = salePetroDetailId;
    }
