 ...
 * @author phuongtu
 */
public class GetVehicleOutListAction extends Action {
        ...
        try {
            ...
            if (importList != null) {
                ...
                for (int i = 0; i < length; i++) {
                    VehicleOutFormBean bean = (VehicleOutFormBean) importList.get(i);
                    buff.append("<row id=\"").append(bean.getId()).append("\">");
                    buff.append("<cell>").append(bean.getCode()).append("^javascript:getVehicleOut(").append(bean.getId()).append(")^_self</cell>");
