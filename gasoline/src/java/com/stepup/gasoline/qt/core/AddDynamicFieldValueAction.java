...
public class AddDynamicFieldValueAction extends SpineAction {
    ...
    public boolean doAction(ActionMapping mapping, ActionForm form,
        ...
        addDynamicFieldValues((DynamicFieldValueParentFormBean) form, QTUtil.getOrganizationId(request.getSession()));
        return result;
    }
    ...
    protected void addDynamicFieldValues(DynamicFieldValueParentFormBean formBean, int organizationId) {
        try {
            DynamicFieldDAO dynamicFieldDAODAO = new DynamicFieldDAO();
            ArrayList arrDetail = dynamicFieldDAODAO.getDynamicFieldValues(this.parentId, getTableName(), organizationId);
