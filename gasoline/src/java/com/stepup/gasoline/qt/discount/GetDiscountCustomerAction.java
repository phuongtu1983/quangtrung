 ...
 * @author phuongtu
 */
public class GetDiscountCustomerAction extends SpineAction {
    ...
    public boolean doAction(ActionMapping mapping, ActionForm form,
        ...
        DiscountCustomerDetailBean customerDetailBean = new DiscountCustomerDetailBean();
        try {
        ...
        request.setAttribute(Constants.DISCOUNT_COMMISSION_CUSTOMER, arrDetail);
