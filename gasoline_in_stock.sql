...
insert  into `fraction_gas`(`id`,`code`,`created_date`,`created_employee_id`,`note`) values (6,'20190908-FG-0001','2019-09-07',17,''),(7,'20190908-FG-0002','2019-09-08',17,'');
...
insert  into `fraction_gas_detail`(`id`,`fraction_id`,`shell_id`,`quantity`) values (1,6,5,'1'),(2,6,1,'2'),(3,6,2,'3'),(4,6,4,'4'),(5,7,5,'5'),(6,7,1,'6'),(7,7,2,'7');
...
insert  into `gas_wholesale_detail`(`id`,`gas_wholesale_id`,`shell_id`,`quantity`,`price`,`amount`) values (19,16,5,8,8000,64000),(20,16,1,9,9000,81000),(21,17,5,10,1000,10000),(22,17,1,11,11000,121000),(23,17,2,12,12000,144000),(24,18,5,1,10000,10000),(25,18,1,2,20000,40000),(26,18,2,3,30000,90000),(27,18,4,4,40000,160000);
...
insert  into `gas_wholesale_fee`(`id`,`name`,`kind`,`status`) values (1,'a',1,1);
...
insert  into `gas_wholesale_fee_detail`(`id`,`gas_wholesale_id`,`fee_id`,`kind`,`amount`,`note`) values (1,18,1,1,0,'');
...
insert  into `oil_import`(`id`,`code`,`created_date`,`vendor_id`,`store_id`,`commission`,`rate`,`total_before_commission`,`total`,`paid`,`debt`,`account_id`,`note`,`created_employee_id`) values (1,'20190909-OI-0001','2019-09-07',20,8,43,0,91434000,52117380,0,52117380,5,'',17),(2,'20190909-OI-0002','2019-09-08',20,9,43,0,172750000,98467500,0,98467500,5,'',17);
...
insert  into `oil_import_detail`(`id`,`oil_import_id`,`oil_id`,`unit_id`,`quantity`,`base_quantity`,`price`,`amount`,`note`) values (1,1,4,13,10,10,43400,434000,NULL),(2,1,5,14,20,20,4550000,91000000,NULL),(3,2,5,14,30,30,4550000,136500000,NULL),(4,2,7,13,40,40,500000,20000000,NULL),(5,2,1,6,50,300,325000,16250000,NULL);
...
insert  into `oil_in_stock`(`id`,`day`,`oil_id`,`organization_id`,`store_id`,`in_stock`) values (1,'2019-09-01',4,1,9,1),(2,'2019-09-01',5,1,9,2),(3,'2019-09-01',7,1,9,3),(4,'2019-09-01',1,1,9,4),(5,'2019-09-01',2,1,9,5),(6,'2019-09-01',3,1,9,6),(7,'2019-09-01',6,1,9,7),(8,'2019-09-01',4,1,8,8),(9,'2019-09-01',5,1,8,9),(10,'2019-09-01',7,1,8,10),(11,'2019-09-01',1,1,8,11),(12,'2019-09-01',2,1,8,12),(13,'2019-09-01',3,1,8,13),(14,'2019-09-01',6,1,8,14),(15,'2019-09-01',4,1,10,15),(16,'2019-09-01',5,1,10,16),(17,'2019-09-01',7,1,10,17),(18,'2019-09-01',1,1,10,18),(19,'2019-09-01',2,1,10,19),(20,'2019-09-01',3,1,10,20),(21,'2019-09-01',6,1,10,21);
...
) ENGINE=MyISAM AUTO_INCREMENT=1363 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

/*Data for the table `shell_in_stock` */

insert  into `shell_in_stock`(`id`,`day`,`organization_id`,`shell_id`,`in_stock`) values (1357,'2019-09-01',14,1,1),(1358,'2019-09-01',14,2,2),(1359,'2019-09-01',1,9,3),(1360,'2019-09-01',1,1,4),(1361,'2019-09-01',1,10,5),(1362,'2019-09-01',1,2,6);
...
insert  into `shield_decrease`(`id`,`code`,`created_date`,`quantity`,`note`,`vendor_id`,`created_employee_id`) values (1,'20190908-SD-0001','2019-09-07',1,'',22,17),(2,'20190908-SD-0002','2019-09-08',2,'',22,17),(3,'20190908-SD-0003','2019-09-07',3,'',23,17),(4,'20190908-SD-0004','2019-09-08',4,'',23,17);
...
insert  into `shield_import`(`id`,`code`,`created_date`,`quantity`,`note`,`vendor_id`,`created_employee_id`) values (1,'20190908-SI-0001','2019-09-07',100,'',22,17),(2,'20190908-SI-0002','2019-09-08',200,'',22,17),(3,'20190908-SI-0003','2019-09-07',300,'',23,17),(4,'20190908-SI-0004','2019-09-08',400,'',23,17);
...
insert  into `shield_in_stock`(`id`,`day`,`vendor_id`,`organization_id`,`in_stock`) values (1,'2019-09-01',15,14,1),(2,'2019-09-01',23,14,2),(3,'2019-09-01',22,14,3),(4,'2019-09-01',24,1,4),(5,'2019-09-01',16,1,5),(6,'2019-09-01',15,1,6),(7,'2019-09-01',21,1,7),(8,'2019-09-01',23,1,8),(9,'2019-09-01',22,1,9);
...
insert  into `wholesale_debt`(`id`,`code`,`created_date`,`content`,`customer_id`,`paid`,`account_id`,`note`,`created_employee_id`,`kind`,`gas_wholesale_id`) values (1,'20190909-DW-0001','2019-09-07',NULL,111,100000,5,'',17,1,0),(2,'20190909-DW-0002','2019-09-08',NULL,222,200000,4,'',17,1,0),(3,'20190920-GS-0001_aut','2019-09-19',NULL,111,1000000,5,'',17,1,18);
...
BEGIN
	SELECT ws.created_date, c.code as customer_code, c.name as customer_name, SUM(tbl.quantity_12) AS quantity_12, SUM(tbl.quantity_45) AS quantity_45
		...
		, coalesce(ws.total,0) as total, (coalesce(ws.paid,0) + coalesce(ws.paid_old_debt_amount,0)) as paid, a.number as account, ws.note
